...
const SPEC_SHADOW_PRIEST = {
  ...
  consumables: {
    nl: [
      ...
      { type:'pot',    name:'Potion of Witchcraft',        effect:'Grote Intellect boost 25 sec.',                note:'Gebruik in Voidform voor maximaal effect' },
    ...
    en: [
      ...
      { type:'pot',    name:'Potion of Witchcraft',        effect:'Large Intellect boost 25 sec.',               note:'Use in Voidform for maximum effect' },
    ...
    da: [
      ...
      { type:'pot',    name:'Potion of Witchcraft',        effect:'Stor Intellect-boost i 25 sek.',              note:'Brug i Voidform for maksimal effekt' },
