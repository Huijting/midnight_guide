...
const LEATHERWORKING = {
  ...
  specs:[
    {
      title:{nl:'📖 Hoe werken specialisaties bij een crafting profession?',en:'📖 How do specializations work for a crafting profession?'},
      desc:{
      ...
      points:{nl:'Tip: craft elke dag iets — ook kleine dingen geven KP en houden je skillups actief',en:'Tip: craft something every day — even small things give KP and keep your skill-ups active'}
    },
    {
      title:{nl:'🎒 Boom 1 — Lasting Leather · Leather armor voor Druids/Rogues',en:'🎒 Tree 1 — Lasting Leather · Leather armor for Druids/Rogues'},
      desc:{
      ...
      points:{nl:'30 punten — dit is de absolute basis van LW, begin hier altijd',en:'30 points — this is the absolute foundation of LW, always start here'}
    },
    {
      title:{nl:'🛡 Boom 2 — Safeguarding Scales · Mail armor voor Hunters/Shamans',en:'🛡 Tree 2 — Safeguarding Scales · Mail armor for Hunters/Shamans'},
      desc:{
      ...
      points:{nl:'30 punten — combineer met Leather Mastery voor maximale orders',en:'30 points — combine with Leather Mastery for maximum orders'}
    },
    {
      title:{nl:'🎓 Boom 3 — Learned Leatherworker · crafting stats en efficiency',en:'🎓 Tree 3 — Learned Leatherworker · crafting stats and efficiency'},
      desc:{
      ...
      points:{nl:'20 punten — unlock dit zo vroeg mogelijk, het betaalt zichzelf snel terug',en:'20 points — unlock this as early as possible, it pays for itself quickly'}
    },
    {
      title:{nl:'🧵 Boom 4 — Flawless Fortes · consumables, leg armor & profession gear',en:'🧵 Tree 4 — Flawless Fortes · consumables, leg armor & profession gear'},
      desc:{
      ...
      points:{nl:'15 punten — recepten komen uit raids, ga actief raiden hiervoor',en:'15 points — recipes come from raids, actively raid for these'}
    }
  ],
  items:[
