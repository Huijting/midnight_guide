...
const ENCHANTING = {
  ...
  specs:[
    {
      title:{nl:'📖 Hoe werkt Enchanting anders dan andere professions?',en:'📖 How does Enchanting differ from other professions?'},
      desc:{
    ...
    {
      title:{nl:'⚔ Boom 1 — Weapon Enchanting · de grootste markt',en:'⚔ Tree 1 — Weapon Enchanting · the biggest market'},
      desc:{
      ...
      points:{nl:'30 punten — altijd eerste investering, universele markt',en:'30 points — always first investment, universal market'}
    },
    {
      title:{nl:'💍 Boom 2 — Ring & Cloak Enchanting',en:'💍 Tree 2 — Ring & Cloak Enchanting'},
      desc:{
      ...
      points:{nl:'25 punten — exclusieve service, niet te vervangen door AH-verkoop',en:'25 points — exclusive service, cannot be replaced by AH sales'}
    },
    {
      title:{nl:'🏠 Boom 3 — Illusions & Cosmetics · premium markt',en:'🏠 Tree 3 — Illusions & Cosmetics · premium market'},
      desc:{
      ...
      points:{nl:'20 punten — ontgrendel zodra je zeldzame Illusion-recepten hebt uit raids',en:'20 points — unlock once you have rare Illusion recipes from raids'}
    }
  ],
  items:[
