...
const SPEC_VENGEANCE_DH = {
  ...
  summary:{nl:"Vengeance Demon Hunter is de meest mobiele tank. Sigil van Flame en Spirit Bomb voor AoE threat. Uitzonderlijk hoge mobiliteit voor een tank via Fel Rush en Metamorphosis.",en:"Vengeance Demon Hunter is the most mobile tank. Sigil of Flame and Spirit Bomb for AoE threat. Exceptionally high mobility for a tank via Fel Rush and Metamorphosis.",da:"Vengeance Demon Hunter er den mest mobile tank. Sigil of Flame og Spirit Bomb til AoE-trussel. Usædvanligt høj mobilitet for en tank via Fel Rush og Metamorphosis."},
  pros:{nl:["Beste mobiliteit van alle tanks", "Uitstekende AoE threat", "Hoge self-healing via Soul Fragments", "Interrupt op 15 sec CD (Disrupt)"],en:["Best mobility of all tanks", "Excellent AoE threat", "High self-healing via Soul Fragments", "Interrupt on 15 sec CD (Disrupt)"],da:["Bedste mobilitet af alle tanks", "Fremragende AoE-trussel", "Høj selvheling via Soul Fragments", "Interrupt på 15 sek CD (Disrupt)"]},
  cons:{nl:["Lagere raw damage reduction dan plate tanks", "Soul Fragment management is complex", "Minder sterk in single target mitigation"],en:["Lower raw damage reduction than plate tanks", "Soul Fragment management is complex", "Weaker in single target mitigation"],da:["Lavere rå skadereduktion end plate-tanks", "Soul Fragment-styring er kompleks", "Svagere i single target-afbødning"]},
  cheatsheet:{
