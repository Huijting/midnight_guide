...
const SPEC_VENGEANCE_DH = {
  ...
  consumables:{
    nl:[
      ...
      {type:'food',  name:'Feisty Fish Sticks',          effect:'Solo food — Agility + Stamina backup.',     note:'Backup als geen feast'},
    ...
    en:[
      ...
      {type:'food',  name:'Feisty Fish Sticks',          effect:'Solo food — Agility + Stamina backup.',    note:'Backup if no feast'},
    ...
    da:[
      ...
      {type:'food',  name:'Feisty Fish Sticks',          effect:'Solo-mad — Agility + Stamina backup.',     note:'Backup hvis ingen feast'},
