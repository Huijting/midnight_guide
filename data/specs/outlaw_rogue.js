...
const SPEC_OUTLAW_ROGUE = {
  ...
  consumables: {
    nl: [
      ...
      { type:'pot',    name:'Potion of Recklessness',             effect:'Agility boost — gebruik bij Adrenaline Rush', note:'Op pull voor maximum effect' },
    ...
    en: [
      ...
      { type:'pot',    name:'Potion of Recklessness',             effect:'Agility boost — use with Adrenaline Rush',  note:'On pull for maximum effect' },
