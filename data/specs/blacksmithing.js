...
const BLACKSMITHING = {
  ...
  specs:[
    {
      title:{nl:'📖 Waarom is Blacksmithing uniek?',en:'📖 Why is Blacksmithing unique?'},
      desc:{
      ...
      points:{nl:'Tip: begin met het maken van je eigen Mining-tools zodra je BS skill 25 hebt — dat maakt je Mining direct efficiënter',en:'Tip: start making your own Mining tools as soon as you have BS skill 25 — that immediately makes your Mining more efficient'}
    },
    {
      title:{nl:'🛡 Boom 1 — Armorsmithing · begin hier',en:'🛡 Tree 1 — Armorsmithing · start here'},
      desc:{
    ...
    },
    {
      ...
      points:{nl:'25 punten — combineer met Plate Mastery voor de meest complete Blacksmithing setup',en:'25 points — combine with Plate Mastery for the most complete Blacksmithing setup'}
    },
    {
      title:{nl:'🔧 Boom 3 — Craftsmithing · profession tools en consumables',en:'🔧 Tree 3 — Craftsmithing · profession tools and consumables'},
      desc:{
      ...
      points:{nl:'25 punten — de meest unieke Blacksmithing-markt, unlock dit zo vroeg mogelijk',en:'25 points — the most unique Blacksmithing market, unlock this as early as possible'}
    },
    {
      title:{nl:'⚡ Boom 4 — The Old Ways · maximaliseer je profession stats',en:'⚡ Tree 4 — The Old Ways · maximize your profession stats'},
      desc:{
      ...
      points:{nl:'20 punten — unlock pas nadat je Plate en/of Weapon-boom hebt, voor gevorderde BS-spelers',en:'20 points — only unlock after you have the Plate and/or Weapon tree, for advanced BS players'}
    }
  ],
  items:[
