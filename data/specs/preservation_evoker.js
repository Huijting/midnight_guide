...
const SPEC_PRESERVATION_EVOKER = {
  ...
  summary:{nl:"Preservation Evoker is een innovatieve healer met Empower spells en tijdmanipulatie via Rewind. Kan de laatste 5 seconden van een speler terugdraaien met Echo.",en:"Preservation Evoker is an innovative healer with Empower spells and time manipulation via Rewind. Can rewind the last 5 seconds of a player with Echo.",da:"Preservation Evoker er en innovativ healer med Empower-trylleformularer og tidsmanipulation via Rewind. Kan spole de sidste 5 sekunder af en spiller tilbage med Echo."},
  pros:{nl:["Unieke tijdmanipulatie mechanics", "Uitstekende burst healing via Essence Burst", "Rewind = krachtigste nood CD", "Goede mobility via Hover"],en:["Unique time manipulation mechanics", "Excellent burst healing via Essence Burst", "Rewind = most powerful emergency CD", "Good mobility via Hover"],da:["Unik tidsmanipulationsmekanik", "Fremragende burst-healing via Essence Burst", "Rewind = kraftigste nød-CD", "God mobilitet via Hover"]},
  cons:{nl:["25 yards bereik — dichter dan andere healers", "Alleen Dracthyr ras", "Empower spells vereisen statisch staan"],en:["25 yard range — closer than other healers", "Dracthyr race only", "Empower spells require standing still"],da:["25 yards rækkevidde — tættere end andre healers", "Kun Dracthyr-racen", "Empower-trylleformularer kræver at stå stille"]},
  cheatsheet:{
