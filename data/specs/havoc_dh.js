...
const SPEC_HAVOC_DH = {
  ...
  consumables: {
    nl: [
      ...
      { type:'pot',    name:'Tempered Potion',             effect:'Grote Agility boost 25 sec bij pull/BL.',     note:'2 per boss: pull + Metamorphosis' },
      { type:'food',   name:'The Sushi Special (Feast)',   effect:'+Agility en Stamina via groepsfeast.',        note:'Feast vragen aan tank/healer' },
      { type:'food',   name:'Feisty Fish Sticks',          effect:'Solo food — hoge Agility bonus.',             note:'Backup als geen feast beschikbaar' },
    ...
    en: [
      ...
      { type:'pot',    name:'Tempered Potion',             effect:'Large Agility boost 25 sec on pull/BL.',     note:'2 per boss: pull + Metamorphosis' },
      { type:'food',   name:'The Sushi Special (Feast)',   effect:'+Agility and Stamina via group feast.',      note:'Ask tank/healer for feast' },
      { type:'food',   name:'Feisty Fish Sticks',          effect:'Solo food — high Agility bonus.',            note:'Backup if no feast available' },
    ...
    da: [
      ...
      { type:'pot',    name:'Tempered Potion',             effect:'Stor Agility-boost 25 sek ved pull/BL.',     note:'2 per boss: pull + Metamorphosis' },
      { type:'food',   name:'The Sushi Special (Feast)',   effect:'+Agility og Stamina via gruppefeast.',       note:'Bed tank/healer om feast' },
      { type:'food',   name:'Feisty Fish Sticks',          effect:'Solo-mad — høj Agility-bonus.',              note:'Backup hvis ingen feast tilgængelig' },
