...
const JEWELCRAFTING = {
  ...
  specs:[
    ...
    {
      title:{nl:'💎 Boom 1 — Glamorous Gems · alle gemsneden en prisms',en:'💎 Tree 1 — Glamorous Gems · all gem cuts and prisms',da:'💎 Træ 1 — Glamorous Gems · alle ædelstenssnit og prismer'},
      desc:{
    ...
    {
      title:{nl:'💍 Boom 2 — Alluring Accessories · ringen, kettingen en profession accessories',en:'💍 Tree 2 — Alluring Accessories · rings, necklaces and profession accessories',da:'💍 Træ 2 — Alluring Accessories · ringe, halskæder og professionstilbehør'},
      desc:{
    ...
    {
      title:{nl:'⚙ Boom 3 — Proficient Processor · prospecting, crushing en reagenten',en:'⚙ Tree 3 — Proficient Processor · prospecting, crushing and reagents',da:'⚙ Træ 3 — Proficient Processor · prospektering, crushing og reagenser'},
      desc:{
