...
const MINING = {
  ...
  trainer:{
    name:'Belil',
    loc:{
      nl:'Trainer <strong>Belil</strong> vind je in de <strong>Craftsmen\'s Quarter</strong> van Silvermoon City — bij smidse en aambeelden (officiële NPC-naam).',
      en:'Trainer <strong>Belil</strong> is in the <strong>Craftsmen\'s Quarter</strong> of Silvermoon City — near forges and anvils (official in-game NPC name).'},
  ...
  specs:[
    {
      title:{nl:'📖 Hoe werkt Mining anders dan andere gathering professions?',en:'📖 How does Mining differ from other gathering professions?'},
      desc:{
      ...
      points:{nl:'Tip: loop altijd een vaste route door een zone — nodes respawnen op dezelfde plekken',en:'Tip: always run a fixed route through a zone — nodes respawn at the same spots'}
    },
    {
      title:{nl:'⛏ Boom 1 — Mining Fundamentals · unlock gemount minen',en:'⛏ Tree 1 — Mining Fundamentals · unlock mounted mining'},
      desc:{
      ...
      points:{nl:'30 punten — absolute basis, altijd als eerste investeren',en:'30 points — absolute foundation, always invest here first'}
    },
    {
      title:{nl:'💎 Boom 2 — Plentiful Ores · meer ore per node en betere kwaliteit',en:'💎 Tree 2 — Plentiful Ores · more ore per node and better quality'},
      desc:{
      ...
      points:{nl:'20 punten — combineer met boom 1 voor maximale farming output',en:'20 points — combine with tree 1 for maximum farming output'}
    },
    {
      title:{nl:'🔮 Boom 3 — Over-LODED · overload infused deposits voor motes',en:'🔮 Tree 3 — Over-LODED · overload infused deposits for motes'},
      desc:{
      ...
      points:{nl:'20 punten — kies dit voor gerichte farming van zeldzame materialen',en:'20 points — choose this for targeted farming of rare materials'}
    },
