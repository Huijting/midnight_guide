...
const TAILORING = {
  ...
  specs:[
    {
      title:{nl:'📖 Tailoring — wie zijn jouw klanten?',en:'📖 Tailoring — who are your customers?'},
      desc:{
      ...
      points:{nl:'Tip: maak altijd cloaks op voorraad — die verkoop je aan elke klasse, niet alleen casters',en:'Tip: always stock cloaks — you sell those to every class, not just casters'}
    },
    {
      title:{nl:"👗 Boom 1 — Sin'dorei Finery · epic cloth armor recepten",en:"👗 Tree 1 — Sin'dorei Finery · epic cloth armor recipes"},
      desc:{
      ...
      points:{nl:'30 punten — begin hier voor maximale armor-orders',en:'30 points — start here for maximum armor orders'}
    },
    {
      title:{nl:'🧵 Boom 2 — Nimble Needlework · dagelijkse bolt cooldowns en speciale cloth',en:'🧵 Tree 2 — Nimble Needlework · daily bolt cooldowns and special cloth'},
      desc:{
      ...
      points:{nl:'25 punten — universele markt, combineer met armor boom voor complete setup',en:'25 points — universal market, combine with armor tree for complete setup'}
    },
    {
      title:{nl:'🧶 Boom 3 — Fabric Specialist · verhoog cloth drop rates',en:'🧶 Tree 3 — Fabric Specialist · increase cloth drop rates'},
      desc:{
      ...
      points:{nl:'15 punten — niche markt maar hoge marge, unlock na de armor en cloak boom',en:'15 points — niche market but high margin, unlock after armor and cloak tree'}
    }
  ],
  items:[
