...
const SPEC_AUGMENTATION_EVOKER = {
  ...
  summary:{nl:"Augmentation Evoker is de enige support DPS spec in WoW. Versterkt medespelers via Ebon Might en Breath of Eons. Schade verschijnt op meter bij andere spelers.",en:"Augmentation Evoker is the only support DPS spec in WoW. Empowers party members via Ebon Might and Breath of Eons. Damage appears on meters as other players' damage.",da:"Augmentation Evoker er den eneste support DPS-spec i WoW. Styrker gruppemedlemmer via Ebon Might og Breath of Eons. Skade vises på meter som andre spilleres skade."},
  pros:{nl:["Unieke support rol — versterkt de hele groep", "Sterk in high-push M+ content", "Ebon Might + Breath of Eons = grote burst window", "Onmisbaar in top-end content"],en:["Unique support role — empowers the whole group", "Strong in high-push M+ content", "Ebon Might + Breath of Eons = major burst window", "Indispensable in top-end content"],da:["Unik supportrolle — styrker hele gruppen", "Stærk i high-push M+-indhold", "Ebon Might + Breath of Eons = stort burst-vindue", "Uundværlig i topindhold"]},
  cons:{nl:["Schade ziet er laag uit op persoonlijke meters", "Moeilijkst te evalueren spec", "Alleen Dracthyr ras", "Effectiviteit afhankelijk van groepssamenstelling"],en:["Damage looks low on personal meters", "Hardest spec to evaluate", "Dracthyr race only", "Effectiveness depends on group composition"],da:["Skade ser lav ud på personlige meters", "Sværeste spec at evaluere", "Kun Dracthyr-racen", "Effektivitet afhænger af gruppesammensætning"]},
  cheatsheet:{
