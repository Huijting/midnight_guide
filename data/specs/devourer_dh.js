...
const SPEC_DEVOURER_DH = {
  ...
  consumables: {
    nl: [
      ...
      { type: 'pot', name: 'Tempered Potion', effect: 'Grote Intellect boost 25 sec bij pull.', note: 'Bij Void Meta venster' },
      { type: 'food', name: 'The Sushi Special (Feast)', effect: '+Intellect en Stamina via groepsfeast.', note: 'Feast vragen' },
      { type: 'food', name: 'Feisty Fish Sticks', effect: 'Solo food — hoge Intellect bonus.', note: 'Backup als geen feast' },
    ...
    en: [
      ...
      { type: 'pot', name: 'Tempered Potion', effect: 'Large Intellect boost 25 sec on pull.', note: 'During Void Meta window' },
      { type: 'food', name: 'The Sushi Special (Feast)', effect: '+Intellect and Stamina via group feast.', note: 'Ask for feast' },
      { type: 'food', name: 'Feisty Fish Sticks', effect: 'Solo food — high Intellect bonus.', note: 'Backup if no feast' },
    ...
    da: [
      ...
      { type: 'pot', name: 'Tempered Potion', effect: 'Stor Intellect-boost 25 sek ved pull.', note: 'Ved Void Meta-vindue' },
      { type: 'food', name: 'The Sushi Special (Feast)', effect: '+Intellect og Stamina via gruppefeast.', note: 'Bed om feast' },
      { type: 'food', name: 'Feisty Fish Sticks', effect: 'Solo-mad — høj Intellect-bonus.', note: 'Backup hvis ingen feast' },
