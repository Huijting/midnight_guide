...
const SPEC_ARCANE_MAGE = {
  ...
  consumables:{
    nl:[
      {type:'flask', name:'Flask of Tempered Mastery', effect:'+Mastery 1 uur. Midnight S1 BiS voor Arcane.',   note:'Altijd actief'},
      ...
      {type:'food',  name:'Feast of the Midnight Masquerade', effect:'Solo/raid feast backup.',                note:'Backup als geen Sushi'},
      {type:'rune',  name:'Crystalline Augment Rune',  effect:'+Primaire stat 1 uur.',                         note:'Altijd gebruiken'},
    ],
    en:[
      {type:'flask', name:'Flask of Tempered Mastery', effect:'+Mastery 1 hour. Midnight S1 BiS for Arcane.',  note:'Always active'},
      ...
      {type:'food',  name:'Feast of the Midnight Masquerade', effect:'Solo/raid feast backup.',                note:'Backup if no Sushi'},
      {type:'rune',  name:'Crystalline Augment Rune', effect:'+Primary stat 1 hour.',                          note:'Always use'},
    ],
    da:[
      {type:'flask', name:'Flask of Tempered Mastery', effect:'+Mastery 1 time. Midnight S1 BiS for Arcane.',  note:'Altid aktiv'},
      ...
      {type:'food',  name:'Feast of the Midnight Masquerade', effect:'Solo/raid feast backup.',                note:'Backup hvis ingen Sushi'},
