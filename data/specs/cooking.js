...
const COOKING = {
  ...
  specs:[
    {
      title:{nl:'📖 Cooking heeft geen specialisaties — dit moet je weten',en:'📖 Cooking has no specialization tree — here\'s what to know'},
      desc:{
      ...
      points:{nl:'Tip: eet altijd voor raids en Mythic+ — gratis stat-bonus naast je flasks',en:'Tip: always eat before raids and Mythic+ — free stat bonus alongside your flasks'}
    },
    {
      title:{nl:'🍖 Categorie 1 — Stat Food · voor Mythic+ en raids',en:'🍖 Category 1 — Stat Food · for Mythic+ and raids'},
      desc:{
      ...
      points:{nl:'30 punten — meest direct nuttig voor je eigen karakter en voor verkoop',en:'30 points — most directly useful for your own character and for sales'}
    },
    {
      title:{nl:'🫕 Categorie 2 — Feasts · de hele groep van buffs voorzien',en:'🫕 Category 2 — Feasts · buffing the entire group'},
        desc:{
      ...
      points:{nl:'20 punten — kies dit als je constant dungeons farmt en efficiëntie wilt maximaliseren',en:'20 points — choose this if you constantly farm dungeons and want to maximize efficiency'}
    }
  ],
  items:[
    {icon:'🍖',name:{nl:'Feast of the Void (raid-tafel)',en:'Feast of the Void (raid table)'},desc:{nl:'Plaatst een tafel waarvoor de hele raid de Well Fed-buff kan pakken. Eén Cook per raid. Verkoop aan raids zonder Cook voor honderden goud per stuk.',en:'Places a table from which the entire raid can take the Well Fed buff. One Cook per raid. Sell to raids without a Cook for hundreds of gold each.'},tag:'consumable'},
    {icon:'🥘',name:{nl:'Combat Dishes (solo/party)',en:'Combat Dishes (solo/party)'},desc:{nl:'Individuele gerechten voor dungeons en solo-content. Elke speler eet ze. Verkopen op het AH of zelf eten voor gratis stats.',en:'Individual dishes for dungeons and solo content. Every player eats them. Sell on AH or eat yourself for free stats.'},tag:'consumable'},
    {icon:'🌿',name:{nl:'Herstelvoedsel',en:'Recovery Food'},desc:{nl:'Herstelt health en mana buiten combat. Bespaart potions. Niche markt maar stabiel voor efficiënte dungeon-farmers.',en:'Restores health and mana out of combat. Saves potions. Niche market but stable for efficient dungeon farmers.'},tag:'consumable'},
    {icon:'🔮',name:{nl:'Void-Infused Dishes (premium)',en:'Void-Infused Dishes (premium)'},desc:{nl:'Speciale gerechten met Void-proc-effect bovenop normale stats. Gevraagd door Mythic-raiders. Premium prijs.',en:'Special dishes with Void proc effect on top of normal stats. In demand by Mythic raiders. Premium price.'},tag:'consumable'}
  ],
  orders:{
