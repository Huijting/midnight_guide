...
const SPEC_WINDWALKER_MONK = {
  ...
  consumables:{
    nl:[
      ...
      {type:'pot',name:'Tempered Potion',effect:'Agility burst bij SEF window.',note:'Op pull'},
      {type:'food',name:'The Sushi Special (Feast)',effect:'+Agility en Stamina.',note:'Feast vragen'},
    ...
    en:[
      ...
      {type:'pot',name:'Tempered Potion',effect:'Agility burst during SEF window.',note:'On pull'},
      {type:'food',name:'The Sushi Special (Feast)',effect:'+Agility and Stamina.',note:'Ask for feast'},
      {type:'food',name:'Feisty Fish Sticks',effect:'Solo food.',note:'Backup'},
    ...
    da:[
      ...
      {type:'pot',name:'Tempered Potion',effect:'Agility-burst under SEF-vindue.',note:'På pull'},
      {type:'food',name:'The Sushi Special (Feast)',effect:'+Agility og Stamina.',note:'Bed om feast'},
