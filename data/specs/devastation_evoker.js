...
const SPEC_DEVASTATION_EVOKER = {
  ...
  summary:{nl:"Devastation Evoker is de Dracthyr ranged DPS. Uniek: middelgroot bereik (25 yards max), Empower spells opladen voor meer kracht. Sterk in burst via Dragonrage.",en:"Devastation Evoker is the Dracthyr ranged DPS. Unique: medium range (25 yards max), Empower spells charge up for more power. Strong in burst via Dragonrage.",da:"Devastation Evoker er Dracthyr ranged DPS. Unikt: mellemlangt rækkevidde (25 yards maks), Empower-trylleformularer oplader til mere kraft. Stærk i burst via Dragonrage."},
  pros:{nl:["Unieke Empower spell mechanic", "Uitstekende burst via Dragonrage", "Goede mobility via Hover", "Hoge schade plafond bij juist gebruik"],en:["Unique Empower spell mechanic", "Excellent burst via Dragonrage", "Good mobility via Hover", "High damage ceiling when used correctly"],da:["Unik Empower-trylleformular-mekanik", "Fremragende burst via Dragonrage", "God mobilitet via Hover", "Højt skadeloft ved korrekt brug"]},
  cons:{nl:["25 yards bereik limiet — dichter dan andere ranged", "Empower timing is complex", "Alleen beschikbaar voor Dracthyr ras"],en:["25 yard range limit — closer than other ranged", "Empower timing is complex", "Only available to Dracthyr race"],da:["25 yards rækkevidde-grænse — tættere end andre ranged", "Empower-timing er kompleks", "Kun tilgængelig for Dracthyr-racen"]},
  cheatsheet:{
