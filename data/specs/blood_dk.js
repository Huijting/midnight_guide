...
const SPEC_BLOOD_DK = {
  ...
  summary:{nl:"Blood Death Knight is de ultieme self-healing tank. Absorbeert schade via Death Strike en genereert enorme zelfheal. Kan crashes overleven die andere tanks doden.",en:"Blood Death Knight is the ultimate self-healing tank. Absorbs damage via Death Strike and generates massive self-heals. Can survive crashes that kill other tanks.",da:"Blood Death Knight er den ultimative selvhealing-tank. Absorberer skade via Death Strike og genererer massiv selvheling. Kan overleve crashes der dræber andre tanks."},
  pros:{nl:["Beste self-healing van alle tanks", "Enorme HP pool", "Sterk in sustained tanking", "Death Grip = unieke pull tool"],en:["Best self-healing of all tanks", "Massive HP pool", "Strong in sustained tanking", "Death Grip = unique pull tool"],da:["Bedste selvheling af alle tanks", "Massiv HP-pulje", "Stærk i vedvarende tanking", "Death Grip = unikt pull-redskab"]},
  cons:{nl:["Lage mobility", "Rune management is complex", "Kwetsbaar voor magic schade burst"],en:["Low mobility", "Rune management is complex", "Vulnerable to magic damage burst"],da:["Lav mobilitet", "Rune-styring er kompleks", "Sårbar over for magic-skade-burst"]},
  cheatsheet:{
