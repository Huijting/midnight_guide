...
const SPEC_ASSASSINATION_ROGUE = {
  ...
  consumables: {
    nl: [
      ...
      { type:'pot',    name:'Tempered Potion',             effect:'Grote Agility boost 25 sec.',                note:'Gebruik bij Vendetta + Deathmark window' },
    ...
    en: [
      ...
      { type:'pot',    name:'Tempered Potion',             effect:'Large Agility boost 25 sec.',               note:'Use during Vendetta + Deathmark window' },
    ...
    da: [
      ...
      { type:'pot',    name:'Tempered Potion',             effect:'Stor Agility-boost i 25 sek.',              note:'Brug under Vendetta + Deathmark-vindue' },
