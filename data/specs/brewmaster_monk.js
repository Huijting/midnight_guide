...
const SPEC_BREWMASTER_MONK = {
  ...
  consumables:{
    nl:[
      {type:'flask',name:'Flask of the Alchemist\'s Shielding',effect:'Verhoogt Agility en Stamina voor 1 uur.',note:'Altijd actief'},
      {type:'pot',name:'Elemental Potion of Power',effect:'Primaire stat boost.',note:'Bij grootste pulls'},
      {type:'food',name:'The Sushi Special (Feast)',effect:'+Agility en Stamina via groepsfeast.',note:'Stamina cruciaal'},
      {type:'food',name:'Feisty Fish Sticks',effect:'Solo food.',note:'Backup'},
      {type:'rune',name:'Crystalline Augment Rune',effect:'+Primaire stat 1 uur.',note:'Altijd'},
    ],
    en:[
      {type:'flask',name:'Flask of the Alchemist\'s Shielding',effect:'Increases Agility and Stamina for 1 hour.',note:'Always active'},
      {type:'pot',name:'Elemental Potion of Power',effect:'Primary stat boost.',note:'On largest pulls'},
      {type:'food',name:'The Sushi Special (Feast)',effect:'+Agility and Stamina via group feast.',note:'Stamina crucial'},
      {type:'food',name:'Feisty Fish Sticks',effect:'Solo food.',note:'Backup'},
      {type:'rune',name:'Crystalline Augment Rune',effect:'+Primary stat 1 hour.',note:'Always'},
    ],
    da:[
      {type:'flask',name:'Flask of the Alchemist\'s Shielding',effect:'Øger Agility og Stamina i 1 time.',note:'Altid aktiv'},
      {type:'pot',name:'Elemental Potion of Power',effect:'Primær stat-boost.',note:'Ved største pulls'},
      {type:'food',name:'The Sushi Special (Feast)',effect:'+Agility og Stamina via gruppefeast.',note:'Stamina afgørende'},
      {type:'food',name:'Feisty Fish Sticks',effect:'Solo-mad.',note:'Backup'},
