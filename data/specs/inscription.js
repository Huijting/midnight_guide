...
const INSCRIPTION = {
  ...
  specs:[
    {
      title:{nl:'📖 De drie markten van Inscription',en:'📖 The three markets of Inscription'},
      desc:{
      ...
      points:{nl:'Tip: focus in de eerste maand op Glyphs — daarna overstappen op Contracts als stabiel inkomen',en:'Tip: focus on Glyphs in the first month — then switch to Contracts for stable income'}
    },
    {
      title:{nl:'📐 Boom 1 — Blueprints · wapens, staves, bows en profession tools',en:'📐 Tree 1 — Blueprints · weapons, staves, bows and profession tools'},
      desc:{
      ...
      points:{nl:'30 punten — stabielste langetermijn-inkomen van Inscription',en:'30 points — most stable long-term income of Inscription'}
    },
    {
      title:{nl:'✋ Boom 2 — Calm Hands · crafting stats + bonus KP per treatise',en:'✋ Tree 2 — Calm Hands · crafting stats + bonus KP per treatise'},
      desc:{
      ...
      points:{nl:'25 punten — hoge prioriteit bij expansie-launch, minder relevant daarna',en:'25 points — high priority at expansion launch, less relevant afterward'}
    },
    {
      title:{nl:'✨ Boom 3 — Perfected Products · kwaliteit voor missives, inkt & contracts',en:'✨ Tree 3 — Perfected Products · quality for missives, ink & contracts'},
      desc:{
      ...
      points:{nl:'20 punten — hoge opbrengst maar willekeurig — combineer met geduldige markthandel',en:'20 points — high yield but random — combine with patient market trading'}
    }
  ],
  items:[
