...
const SPEC_ENHANCEMENT_SHAMAN = {
  ...
  weapon:{nl:'Twee eenhandige wapens (dual wield)',en:'Two one-hand weapons (dual wield)',da:'To enhåndsvåben (dual wield)'},
  resource:'Mana + Maelstrom',
  patch:'1.0', color:'#0070DE',
  summary:{nl:"Enhancement Shaman is een melee DPS vol elementaire kracht. Combineert Maelstrom Weapon procs met instant Lightning Bolt en Chain Lightning voor sterke burst.",en:"Enhancement Shaman is a melee DPS full of elemental power. Combines Maelstrom Weapon procs with instant Lightning Bolt and Chain Lightning for strong burst.",da:"Enhancement Shaman er en melee DPS fuld af elementær kraft. Kombinerer Maelstrom Weapon-procs med instant Lightning Bolt og Chain Lightning til stærk burst."},
  pros:{nl:["Unieke melee/caster hybride", "Uitstekende AoE burst", "Sterke Bloodlust/Heroism bijdrage", "Goede utility (totems)"],en:["Unique melee/caster hybrid", "Excellent AoE burst", "Strong Bloodlust/Heroism contribution", "Good utility (totems)"],da:["Unik melee/caster-hybrid", "Fremragende AoE-burst", "Stærkt Bloodlust/Heroism-bidrag", "God utility (totems)"]},
  cons:{nl:["Rng-afhankelijk (Maelstrom procs)", "Relatief laag bereik als melee", "Komplex door meerdere proc-types"],en:["RNG-dependent (Maelstrom procs)", "Relatively limited range as melee", "Complex due to multiple proc types"],da:["RNG-afhængig (Maelstrom-procs)", "Relativt begrænset rækkevidde som melee", "Kompleks på grund af flere proc-typer"]},
  cheatsheet:{
