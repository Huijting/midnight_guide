...
const SPEC_RESTORATION_SHAMAN = {
  ...
  summary:{nl:"Restoration Shaman healt via HoTs (Riptide) en krachtige chain heals. Chain Heal bounce-systeem maakt het excelleren in packed groepen. Beste utility-healer.",en:"Restoration Shaman heals via HoTs (Riptide) and powerful chain heals. Chain Heal bounce system makes it excel in packed groups. Best utility healer.",da:"Restoration Shaman healer via HoTs (Riptide) og kraftfulde chain heals. Chain Heal bounce-system gør det fremragende i tæt pakkede grupper. Bedste utility-healer."},
  pros:{nl:["Chain Heal = meest efficiënte AoE heal", "Uitstekende utility (Wind Rush, totems)", "Spiritwalker's Grace = healen tijdens movement", "Earthen Wall Totem = grote groeps CD"],en:["Chain Heal = most efficient AoE heal", "Excellent utility (Wind Rush, totems)", "Spiritwalker's Grace = heal while moving", "Earthen Wall Totem = large group CD"],da:["Chain Heal = mest effektiv AoE-heal", "Fremragende utility (Wind Rush, totems)", "Spiritwalker's Grace = heal under bevægelse", "Earthen Wall Totem = stor gruppe-CD"]},
  cons:{nl:["Minder sterk in pure single target", "Chain Heal vereist goede positie", "Mana intensief bij veel AoE gebruik"],en:["Weaker in pure single target", "Chain Heal requires good positioning", "Mana intensive with lots of AoE usage"],da:["Svagere i ren single target", "Chain Heal kræver god positionering", "Manaintensiv ved meget AoE-brug"]},
  cheatsheet:{
