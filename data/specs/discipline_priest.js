...
const SPEC_DISCIPLINE_PRIEST = {
  ...
  summary:{nl:"Discipline Priest healt door schade te doen via Atonement. Elke schade spell genereert heals op spelers met Atonement debuff. Uniek en complex healerssysteem.",en:"Discipline Priest heals by dealing damage via Atonement. Every damage spell generates heals on players with Atonement debuff. Unique and complex healer system.",da:"Discipline Priest healer ved at gøre skade via Atonement. Hver skadetrylleformel genererer heals på spillere med Atonement-debuff. Unikt og komplekst healersystem."},
  pros:{nl:["Uniek schade-heals systeem", "Uitstekende preventieve healing", "Power Word: Barrier is beste groeps CD", "Sterke shields (PW:S)"],en:["Unique damage-heals system", "Excellent preventative healing", "Power Word: Barrier is best group CD", "Strong shields (PW:S)"],da:["Unikt skade-heals-system", "Fremragende forebyggende healing", "Power Word: Barrier er bedste gruppe-CD", "Stærke skjolde (PW:S)"]},
  cons:{nl:["Moeilijkste healer om te leren", "Lage reactieve healing", "Atonement moet constant uitgedeeld worden"],en:["Hardest healer to learn", "Low reactive healing", "Atonement must be constantly distributed"],da:["Sværeste healer at lære", "Lav reaktiv healing", "Atonement skal konstant uddeles"]},
  cheatsheet:{
