...
const SPEC_GUARDIAN_DRUID = {
  ...
  consumables: {
    nl: [
      { type:'flask',  name:'Flask of the Focused Dream',  effect:'Verhoogt Agility (ook armor) voor 1 uur.',    note:'Altijd actief als tank' },
      { type:'pot',    name:'Elemental Potion of Power',   effect:'Primaire stat boost voor surviveability.',     note:'Gebruik bij grootste pull of boss opener' },
      { type:'food',   name:'The Sushi Special (Feast)',   effect:'+Agility en Stamina via groepsfeast.',        note:'Stamina is cruciaal als tank' },
      { type:'food',   name:'Seamoth Surprise',            effect:'Solo tank food — hoge Stamina bonus.',        note:'Backup als geen feast' },
      { type:'rune',   name:'Crystalline Augment Rune',    effect:'+Primaire stat 1 uur.',                       note:'Altijd gebruiken' },
    ],
    en: [
      { type:'flask',  name:'Flask of the Focused Dream',  effect:'Increases Agility (also armor) for 1 hour.',  note:'Always active as tank' },
      { type:'pot',    name:'Elemental Potion of Power',   effect:'Primary stat boost for survivability.',       note:'Use during largest pull or boss opener' },
      { type:'food',   name:'The Sushi Special (Feast)',   effect:'+Agility and Stamina via group feast.',      note:'Stamina is crucial as tank' },
      { type:'food',   name:'Seamoth Surprise',            effect:'Solo tank food — high Stamina bonus.',       note:'Backup if no feast' },
      { type:'rune',   name:'Crystalline Augment Rune',    effect:'+Primary stat 1 hour.',                      note:'Always use' },
    ],
    da: [
      { type:'flask',  name:'Flask of the Focused Dream',  effect:'Øger Agility (også armor) i 1 time.',         note:'Altid aktiv som tank' },
      { type:'pot',    name:'Elemental Potion of Power',   effect:'Primær stat-boost til overlevelse.',          note:'Brug ved største pull eller boss-opener' },
      { type:'food',   name:'The Sushi Special (Feast)',   effect:'+Agility og Stamina via gruppefeast.',        note:'Stamina er afgørende som tank' },
      { type:'food',   name:'Seamoth Surprise',            effect:'Solo tank-mad — høj Stamina-bonus.',          note:'Backup hvis ingen feast' },
