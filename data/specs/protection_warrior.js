...
const SPEC_PROTECTION_WARRIOR = {
  ...
  summary:{nl:"Protection Warrior is de actieve tank — genereert Rage via aanvallen en schade ontvangen. Gebruikt Ignore Pain als schild en heeft sterke AoE threat.",en:"Protection Warrior is the active tank — generates Rage via attacks and taking damage. Uses Ignore Pain as a shield and has strong AoE threat.",da:"Protection Warrior er den aktive tank — genererer Rage via angreb og at tage skade. Bruger Ignore Pain som skjold og har stærk AoE-trussel."},
  pros:{nl:["Uitstekende AoE threat", "Hoge Rage generatie via schade", "Sterk burst damage voor een tank", "Goede interrupt met Pummel"],en:["Excellent AoE threat", "High Rage generation via damage taken", "Strong burst damage for a tank", "Good interrupt with Pummel"],da:["Fremragende AoE-trussel", "Høj Rage-generering via modtaget skade", "Stærk burst-skade til en tank", "God interrupt med Pummel"]},
  cons:{nl:["Minder defensieve CDs dan andere tanks", "Rage management vereist aandacht", "Kwetsbaar bij lage Rage"],en:["Fewer defensive CDs than other tanks", "Rage management requires attention", "Vulnerable at low Rage"],da:["Færre defensive CDs end andre tanks", "Rage-styring kræver opmærksomhed", "Sårbar ved lav Rage"]},
  cheatsheet:{
