...
const SPEC_UNHOLY_DK = {
  ...
  role:'melee', armor:'Plate',
  weapon:{nl:'Tweehandig wapen',en:'Two-hand weapon',da:'Tohåndsvåben'},
  resource:'Runes + Runic Power',
  patch:'1.0', color:'#C41E3A',
  summary:{nl:"Unholy Death Knight commandeert een leger van de doden. Legt vijanden vol met ziekte en laat je Ghoul en Apochalypse burst je schade vertienvoudigen.",en:"Unholy Death Knight commands an army of the dead. Loads enemies with disease and lets your Ghoul and Apocalypse burst multiply your damage tenfold.",da:"Unholy Death Knight kommanderer en hær af de døde. Fylder fjender med sygdom og lader din Ghoul og Apocalypse-burst mangfoldiggøre din skade."},
  pros:{nl:["Uitstekende AoE burst via Apocalypse", "Permanent pet (Ghoul)", "Sterk in langere fights", "Goede utility (Death Grip, Strangulate)"],en:["Excellent AoE burst via Apocalypse", "Permanent pet (Ghoul)", "Strong in longer fights", "Good utility (Death Grip, Strangulate)"],da:["Fremragende AoE-burst via Apocalypse", "Permanent kæledyr (Ghoul)", "Stærk i længere kampe", "God utility (Death Grip, Strangulate)"]},
  cons:{nl:["Lage mobiliteit", "Rune management is complex", "Lage burst zonder Apocalypse"],en:["Low mobility", "Rune management is complex", "Low burst without Apocalypse"],da:["Lav mobilitet", "Rune-styring er kompleks", "Lav burst uden Apocalypse"]},
  cheatsheet:{
