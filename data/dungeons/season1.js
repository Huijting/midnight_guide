...
// ──────────────────────────────────────────────
{
  ...
  tips:[
    {title:{nl:"Ingangcoördinaten",en:"Entrance coordinates",da:"Indgangskoordinater"},
     text:{nl:"/way 35.5, 78.8 — Eversong Woods, vlak bij de klifrand.",en:"/way 35.5, 78.8 — Eversong Woods, near the cliff edge.",da:"/way 35.5, 78.8 — Eversong Woods, nær klippekanten."}},
  ...
  route:{
    ...
    trash:[
      {mob:"Dutiful Groundskeeper",tags:["tank"],tip:{nl:"Shear Armor: melee-aanvallen stapelen armor debuff op de tank — defensive of kite bij hoge stacks.",en:"Shear Armor: melee attacks stack armor debuff on the tank — defensive or kite on high stacks.",da:"Shear Armor: melee-angreb stabler armor debuff på tanken — defensive eller kite ved høje stacks."}},
      {mob:"Restless Steward",tags:["int","purge"],tip:{nl:"Spirit Bolt: interrupt zo veel mogelijk. Soul Torment: magic debuff op 2 spelers — dispel direct.",en:"Spirit Bolt: interrupt as much as possible. Soul Torment: magic debuff on 2 players — dispel immediately.",da:"Spirit Bolt: afbryd så meget som muligt. Soul Torment: magic debuff på 2 spillere — dispel straks."}},
      {mob:"Spellguard Magus",tags:["tank","stop"],tip:{nl:"CC-immuun. Arcane Salvo = groeps-AoE — defensive klaar. Bij 50% HP: Spellguard's Protection = 99% DR-zone op de grond — sleep de mob er DIRECT uit!",en:"CC-immune. Arcane Salvo = group AoE — defensive ready. At 50% HP: Spellguard's Protection = 99% DR zone — move the mob OUT immediately!",da:"CC-immun. Arcane Salvo = gruppe-AoE — defensive klar. Ved 50% HP: Spellguard's Protection = 99% DR-zone — flyt mob STRAKS ud!"}},
      {mob:"Territorial Dragonhawk",tags:["int","purge"],tip:{nl:"Fire Spit: channel op random speler — CC of interrupt. Bolstering Flames: buff op de mob — purge direct.",en:"Fire Spit: channels into random player — CC or interrupt. Bolstering Flames: buff on mob — purge immediately.",da:"Fire Spit: channel på tilfældig spiller — CC eller afbryd. Bolstering Flames: buff på mob — purge straks."}},
      {mob:"Creeping Spindleweb",tags:["purge","avoid"],tip:{nl:"Poison Spray: poison debuff op random speler — poison dispel. Acidic Demise: plas bij dood — stap weg als de mob sterft.",en:"Poison Spray: poison debuff on random player — poison dispel. Acidic Demise: puddle on death — step away when the mob dies.",da:"Poison Spray: poison debuff på tilfældig spiller — poison dispel. Acidic Demise: pøl ved død — træd væk når mob dør."}},
      {mob:"Apex Lynx",tags:["tank","stop"],tip:{nl:"CC-immuun. Puncturing Bite: bleed op tank — defensive of bleed cleanse. Ferocious Pounce: springt tussen 3 spelers — losjes spreiden.",en:"CC-immune. Puncturing Bite: bleed on tank — defensive or bleed cleanse. Ferocious Pounce: leaps between 3 players — loosely spread.",da:"CC-immun. Puncturing Bite: bleed på tank — defensive eller bleed cleanse. Ferocious Pounce: springer mellem 3 spillere — løs spredning."}},
      {mob:"Bloated Lasher",tags:["int","tank"],tip:{nl:"Fungal Bolt: interrupt elke cast. Spore Dispersal: groeps-AoE + versterkt omliggende Lashlings 8 sec — cooldown + tank defensive.",en:"Fungal Bolt: interrupt every cast. Spore Dispersal: group AoE + empowers nearby Lashlings for 8s — cooldown + tank defensive.",da:"Fungal Bolt: afbryd hvert cast. Spore Dispersal: gruppe-AoE + styrker nærliggende Lashlings i 8 sek — cooldown + tank defensive."}},
      {mob:"Ardent Cutthroat",tags:["int","purge"],tip:{nl:"Poison Blades: interrupt elke cast. Shadowrive: lijn-aanval op random speler — stack melee voor cleave.",en:"Poison Blades: interrupt every cast. Shadowrive: line attack on random player — stack melee for cleave.",da:"Poison Blades: afbryd hvert cast. Shadowrive: linjeangrebet på tilfældig spiller — stack melee til cleave."}},
      {mob:"Devoted Woebringer",tags:["int","stop"],tip:{nl:"CC-immuun. Shadow Bolt: interrupt elke cast. Pulsing Shriek: schild + zware groepsschade — doorbreek het schild direct.",en:"CC-immune. Shadow Bolt: interrupt every cast. Pulsing Shriek: shield + heavy group damage — break the shield immediately.",da:"CC-immun. Shadow Bolt: afbryd hvert cast. Pulsing Shriek: skjold + tung gruppeskade — bryd skjoldet straks."}},
      {mob:"Swiftshot Archer",tags:["avoid","stop"],tip:{nl:"Arrow Rain: channel met AoE-cirkels — CC de mob of dodge alle cirkels. Break Ranks: charge naar random speler — stap opzij.",en:"Arrow Rain: channel with AoE circles — CC the mob or dodge all circles. Break Ranks: charges random player — step to the side.",da:"Arrow Rain: channel med AoE-cirkler — CC mob eller undgå alle cirkler. Break Ranks: charge mod tilfældig spiller — træd til siden."}},
      {mob:"Storming Soulfont",tags:["stop"],tip:{nl:"Geeft energie aan The Restless Heart als hij lang leeft — CC of kill snel. Gust Shot van de baas vernietigt Soulfonts.",en:"Feeds energy to The Restless Heart if it lives long — CC or kill fast. Gust Shot from Restless Heart destroys Soulfonts.",da:"Giver energi til The Restless Heart hvis den lever længe — CC eller dræb hurtigt. Gust Shot fra Restless Heart ødelægger Soulfonts."}}
    ],
...
// ──────────────────────────────────────────────
{
  ...
  route:{
    ...
    trash:[
      {mob:"Arcane Sentry",tags:["tank","purge"],tip:{nl:"CC-immuun. Ethereal Shackles op tank: magic dispel of root break. Arcane Beam: channel op random speler, dodge de plas. Crowd Dispersal: knockback.",en:"CC-immune. Ethereal Shackles on tank: magic dispel or root break. Arcane Beam: channels into random player, dodge the puddle. Crowd Dispersal: knockback.",da:"CC-immun. Ethereal Shackles på tank: magic dispel eller root break. Arcane Beam: channel på tilfældig spiller, undgå pølen. Crowd Dispersal: knockback."}},
      {mob:"Arcane Magister",tags:["int","purge"],tip:{nl:"Polymorph: #1 interrupt prioriteit elke cast — als het doorgaat: magic dispel direct. Arcane Bolt: spare interrupts.",en:"Polymorph: #1 interrupt priority every cast — if it goes off: magic dispel immediately. Arcane Bolt: spare interrupts.",da:"Polymorph: #1 interrupt prioritet hvert cast — hvis det slipper igennem: magic dispel straks. Arcane Bolt: spare interrupts."}},
      {mob:"Sunblade Enforcer",tags:["tank","purge"],tip:{nl:"Arcane Blade: magic buff op de mob — purge direct. Charge als de tank wegloopt.",en:"Arcane Blade: magic buff on the mob — purge immediately. Charges if tank moves away.",da:"Arcane Blade: magic buff på mob — purge straks. Charge hvis tanken bevæger sig væk."}},
      {mob:"Lightward Healer",tags:["purge"],tip:{nl:"Holy Fire: magic debuff op random speler — dispel. Power Word: Shield: buff op ally — purge.",en:"Holy Fire: magic debuff on random player — dispel. Power Word: Shield: buff on ally — purge.",da:"Holy Fire: magic debuff på tilfældig spiller — dispel. Power Word: Shield: buff på ally — purge."}},
      {mob:"Animated Codex",tags:["tank"],tip:{nl:"Arcane Volley: constant groeps-AoE pulseren. Niet te veel tegelijk pullen — grote cooldowns snel nodig.",en:"Arcane Volley: constant group AoE pulsing. Don't pull too many at once — major cooldowns needed fast.",da:"Arcane Volley: konstant gruppe-AoE pulserende. Træk ikke for mange på én gang — store cooldowns hurtigt nødvendige."}},
      {mob:"Blazing Pyromancer",tags:["int","avoid"],tip:{nl:"CC-immuun. Pyroblast: interrupt elke cast. Flamestrike: AoE plas — dodge. Ignition: defensives inzetten.",en:"CC-immune. Pyroblast: interrupt every cast. Flamestrike: AoE puddle — dodge. Ignition: use defensives.",da:"CC-immun. Pyroblast: afbryd hvert cast. Flamestrike: AoE pøl — undgå. Ignition: brug defensives."}},
      {mob:"Brightscale Wyrm",tags:["stop"],tip:{nl:"Energy Release bij dood: AoE explosie + buff op de groep — staan naast hem voor de buff. Stagger kills om simultane explosies te vermijden.",en:"Energy Release on death: AoE explosion + group buff — stand near it for the buff. Stagger kills to avoid simultaneous explosions.",da:"Energy Release ved død: AoE eksplosion + gruppe-buff — stå nær den for buff. Stagger kills for at undgå samtidige eksplosioner."}},
      {mob:"Shadowrift Voidcaller",tags:["int","stop"],tip:{nl:"Tough mob (geen CC). Call of the Void: summon adds — interrupt ELKE cast. Consuming Shadows: zware groeps-AoE, LoS om schade te vermijden.",en:"Tough mob (no CC). Call of the Void: summons adds — interrupt EVERY cast. Consuming Shadows: heavy group AoE, LoS to avoid damage.",da:"Tough mob (ingen CC). Call of the Void: summoner adds — afbryd HVERT cast. Consuming Shadows: tung gruppe-AoE, LoS for at undgå skade."}},
      {mob:"Devouring Tyrant",tags:["tank","avoid"],tip:{nl:"Tough mob. Devouring Strike: tank healing absorb. Void Bomb op random speler: healing absorb + AoE plas — loop weg van de groep.",en:"Tough mob. Devouring Strike: tank healing absorb. Void Bomb on random player: healing absorb + AoE puddle — move away from group.",da:"Tough mob. Devouring Strike: tank healing-absorb. Void Bomb på tilfældig spiller: healing-absorb + AoE pøl — gå væk fra gruppen."}}
    ],
    mdt:true, kg_url:"https://keystone.guru/routes/expansion/midnight/season/1"
  }
},
...
// ──────────────────────────────────────────────
{
  ...
  route:{
    ...
    trash:[
      {mob:"Frenzied Berserker",tags:["tank","purge"],tip:{nl:"Blood Frenzy: enrage op de mob — sooth. Regeneratin': passieve healing, healing reduction is effectief.",en:"Blood Frenzy: enrage on the mob — sooth. Regeneratin': passive healing, healing reduction is effective.",da:"Blood Frenzy: enrage på mob — sooth. Regeneratin': passiv healing, healing-reduktion er effektiv."}},
      {mob:"Dread Souleater",tags:["tank","avoid"],tip:{nl:"CC-immuun. Necrotic Wave: healing absorb op alle spelers — stagger defensives. Rain of Toads: AoE cirkels — dodge.",en:"CC-immune. Necrotic Wave: healing absorb on all players — stagger defensives. Rain of Toads: AoE circles — dodge.",da:"CC-immun. Necrotic Wave: healing-absorb på alle spillere — stagger defensives. Rain of Toads: AoE-cirkler — undgå."}},
      {mob:"Keen Headhunter",tags:["int","stop"],tip:{nl:"Hooked Snare: snare op random speler — interrupt of freedom. Throw Spear: stack in melee (minimum range).",en:"Hooked Snare: snare on random player — interrupt or freedom. Throw Spear: stack in melee (minimum range).",da:"Hooked Snare: snare på tilfældig spiller — afbryd eller freedom. Throw Spear: stack i melee (minimum range)."}},
      {mob:"Hulking Juggernaut",tags:["tank","stop"],tip:{nl:"CC-immuun. Rending Gore: bleed op tank — defensive of bleed cleanse. Deafening Roar: onderbreekt spellcasts — stop casting als hij dit begint.",en:"CC-immune. Rending Gore: bleed on tank — defensive or bleed cleanse. Deafening Roar: interrupts spellcasting — stop casting when it begins.",da:"CC-immun. Rending Gore: bleed på tank — defensive eller bleed cleanse. Deafening Roar: afbryder spellcasting — stop med at caste når den begynder."}},
      {mob:"Grim Skirmisher",tags:["avoid"],tip:{nl:"Grim Ward: buff op de mob. Meerdere Wards tegelijk doorbreken = groeps-AoE. Break ze één voor één.",en:"Grim Ward: buff on the mob. Breaking multiple Wards simultaneously = group AoE. Break them one at a time.",da:"Grim Ward: buff på mob. Bryde flere Wards simultant = gruppe-AoE. Bryd dem én ad gangen."}},
      {mob:"Reanimated Warrior",tags:["stop"],tip:{nl:"Reanimation bij 0 HP: probeert zichzelf te reviven — CC direct bij 0 HP, dan snel doden.",en:"Reanimation at 0 HP: attempts to revive itself — CC immediately at 0 HP, then kill fast.",da:"Reanimation ved 0 HP: forsøger at revive sig selv — CC straks ved 0 HP, derefter dræb hurtigt."}},
      {mob:"Hollow Soulrender",tags:["int","avoid"],tip:{nl:"Tough mob. Shadowfrost Blast: interrupt. Frost Nova: AoE freeze — root break of dodge. Rend Souls: tank schade.",en:"Tough mob. Shadowfrost Blast: interrupt. Frost Nova: AoE freeze — root break or dodge. Rend Souls: tank damage.",da:"Tough mob. Shadowfrost Blast: afbryd. Frost Nova: AoE freeze — root break eller undgå. Rend Souls: tank skade."}},
      {mob:"Zil'jan",tags:["avoid"],tip:{nl:"Mini-boss op de brug. Ritual Drums: zware puls-AoE + stuiterende shadow orbs over de brug. Kill hem snel en ontwijkt orbs bij het oversteken.",en:"Mini-boss on the bridge. Ritual Drums: heavy pulse AoE + bouncing shadow orbs down the bridge. Kill him fast and dodge orbs while crossing.",da:"Mini-boss på broen. Ritual Drums: tung puls-AoE + strittende shadow orbs ned ad broen. Dræb ham hurtigt og undgå orbs mens du krydser."}},
      {mob:"Rokh'zal",tags:["int","stop"],tip:{nl:"Tough mini-boss. Invoke Shadow: interrupt. Ritual Sacrifice: interrupt! Als hij dit voltooit voor hij dood is = wipe.",en:"Tough mini-boss. Invoke Shadow: interrupt. Ritual Sacrifice: interrupt! If he completes this before dying = wipe.",da:"Tough mini-boss. Invoke Shadow: afbryd. Ritual Sacrifice: afbryd! Hvis han fuldfører dette inden han dør = wipe."}}
    ],
...
// ──────────────────────────────────────────────
{
  ...
  route:{
    ...
    trash:[
      {mob:"Flux Engineer",tags:["avoid","tank"],tip:{nl:"Suppression Field: AoE op random speler — losjes spreiden, minimaal bewegen als getarget. Laat Mana Battery achter bij dood — direct vernietigen!",en:"Suppression Field: AoE on random player — loosely spread, minimal movement if targeted. Drops Mana Battery on death — destroy immediately!",da:"Suppression Field: AoE på tilfældig spiller — løs spredning, minimal bevægelse hvis målrettet. Efterlader Mana Battery ved død — ødelæg straks!"}},
      {mob:"Circuit Seer",tags:["tank","stop"],tip:{nl:"CC-immuun. Arcing Mana: channel, defensive. Activeert Mana Batteries — switch en vernietig ze binnen 12 sec (Corespark Overload = raidwipe DoT).",en:"CC-immune. Arcing Mana: channel, defensive. Activates Mana Batteries — swap and destroy within 12s (Corespark Overload = raid wipe DoT).",da:"CC-immun. Arcing Mana: channel, defensive. Aktiverer Mana Batteries — skift og ødelæg inden 12 sek (Corespark Overload = raid wipe DoT)."}},
      {mob:"Nexus Adept",tags:["int"],tip:{nl:"Umbral Bolt: spare interrupts op deze mob.",en:"Umbral Bolt: use spare interrupts on this mob.",da:"Umbral Bolt: brug spare interrupts på denne mob."}},
      {mob:"Cursed Voidcaller",tags:["int"],tip:{nl:"Creeping Void: interrupt. Zware caster — prioriteit bij grotere pulls.",en:"Creeping Void: interrupt. Heavy caster — priority target in larger pulls.",da:"Creeping Void: afbryd. Tung caster — prioritetsmål i større pulls."}},
      {mob:"Dreadflail",tags:["tank","stop"],tip:{nl:"Tough mob. Void Lash: tank cleave. Flailstorm: groeps-AoE — defensives.",en:"Tough mob. Void Lash: tank cleave. Flailstorm: group AoE — defensives.",da:"Tough mob. Void Lash: tank cleave. Flailstorm: gruppe-AoE — defensives."}},
      {mob:"Grand Nullifier",tags:["int","avoid"],tip:{nl:"Nascent Energy: grote AoE — interrupt. Nullify: interrupt of tank defensive.",en:"Nascent Energy: large AoE — interrupt. Nullify: interrupt or tank defensive.",da:"Nascent Energy: stor AoE — afbryd. Nullify: afbryd eller tank defensive."}},
      {mob:"Null Sentinel",tags:["int","stop"],tip:{nl:"Tough mob. Nullwark Blast: interrupt. Dreadbellow: interrupt — anders groepsschade.",en:"Tough mob. Nullwark Blast: interrupt. Dreadbellow: interrupt — otherwise group damage.",da:"Tough mob. Nullwark Blast: afbryd. Dreadbellow: afbryd — ellers gruppeskade."}},
      {mob:"Flarebat",tags:["purge","avoid"],tip:{nl:"Holy Echo buff bij dood: AoE-zone + healt vijanden — purge als mogelijk vóór dood. Radiant Swarm: fixate op random speler — kite weg.",en:"Holy Echo buff on death: AoE zone + heals enemies — purge before death if possible. Radiant Swarm: fixates random player — kite away.",da:"Holy Echo buff ved død: AoE-zone + healer fjender — purge inden død hvis muligt. Radiant Swarm: fixerer tilfældig spiller — kite væk."}},
      {mob:"Lightwrought",tags:["int","purge"],tip:{nl:"Holy Bolt: interrupt. Burning Radiance: magic debuff op 2 spelers — dispel direct.",en:"Holy Bolt: interrupt. Burning Radiance: magic debuff on 2 players — dispel immediately.",da:"Holy Bolt: afbryd. Burning Radiance: magic debuff på 2 spillere — dispel straks."}},
      {mob:"Lingering Image",tags:["stop","avoid"],tip:{nl:"Fixate op random speler — kite. Cluster Weakness: passief extra AoE schade. Kill snel voor Lothraxion.",en:"Fixates random player — kite. Cluster Weakness: passively takes extra AoE damage. Kill fast before Lothraxion.",da:"Fixerer tilfældig spiller — kite. Cluster Weakness: passivt ekstra AoE-skade. Dræb hurtigt inden Lothraxion."}}
    ],
    mdt:true, kg_url:"https://keystone.guru/routes/expansion/midnight/season/1"
  }
},
...
// ──────────────────────────────────────────────
{
  ...
  route:{
    ...
    trash:[
      {mob:"Vile Lasher",tags:["tank","avoid"],tip:{nl:"CC-immuun. Vile Bite: bleed stacks op tank — defensive of bleed cleanse. Detonation Seeds: swirly onder elke speler — dodge.",en:"CC-immune. Vile Bite: bleed stacks on tank — defensive or bleed cleanse. Detonation Seeds: swirly under every player — dodge.",da:"CC-immun. Vile Bite: bleed stacks på tank — defensive eller bleed cleanse. Detonation Seeds: swirly under hver spiller — undgå."}},
      {mob:"Aggravated Skitterfly",tags:["purge","tank"],tip:{nl:"Agitation: enrage buff op de mob — sooth. Darting Sting op random speler.",en:"Agitation: enrage buff on the mob — sooth. Darting Sting on random player.",da:"Agitation: enrage buff på mob — sooth. Darting Sting på tilfældig spiller."}},
      {mob:"Guardian Sentry",tags:["tank","avoid"],tip:{nl:"CC-immuun. Storm Slash: tankbuster. Deadly Winds: tornado op random speler — dodge. Expel Intruders: grote AoE — LoS achter pilaar.",en:"CC-immune. Storm Slash: tank buster. Deadly Winds: tornado on random player — dodge. Expel Intruders: large AoE — LoS behind a pillar.",da:"CC-immun. Storm Slash: tankbuster. Deadly Winds: tornado på tilfældig spiller — undgå. Expel Intruders: stor AoE — LoS bag søjle."}},
      {mob:"Alpha Eagle",tags:["int","avoid"],tip:{nl:"Tough mob. Raging Screech: zware groeps-AoE — interrupt! Gust: frontal knockback — stap opzij.",en:"Tough mob. Raging Screech: heavy group AoE — interrupt! Gust: frontal knockback — step to the side.",da:"Tough mob. Raging Screech: tung gruppe-AoE — afbryd! Gust: frontal knockback — træd til siden."}},
      {mob:"Algeth'ar Echoknight",tags:["tank","stop"],tip:{nl:"Tough mob. Arcane Smash: massieve groeps-AoE — grote defensive/cooldown.",en:"Tough mob. Arcane Smash: massive group AoE — major defensive/cooldown.",da:"Tough mob. Arcane Smash: massiv gruppe-AoE — stor defensive/cooldown."}},
      {mob:"Spectral Invoker",tags:["int"],tip:{nl:"Arcane Bolt: interrupt. Mystic Brand: debuff op random speler.",en:"Arcane Bolt: interrupt. Mystic Brand: debuff on random player.",da:"Arcane Bolt: afbryd. Mystic Brand: debuff på tilfældig spiller."}},
      {mob:"Corrupted Manafiend",tags:["int","avoid"],tip:{nl:"Surge: interrupt. Mana Void: AoE zone — dodge.",en:"Surge: interrupt. Mana Void: AoE zone — dodge.",da:"Surge: afbryd. Mana Void: AoE-zone — undgå."}}
    ],
    mdt:true, kg_url:"https://keystone.guru/routes/expansion/midnight/season/1"
  }
},
...
// ──────────────────────────────────────────────
{
  ...
  route:{
    ...
    trash:[
      {mob:"Merciless Subjugator",tags:["tank","purge"],tip:{nl:"CC-immuun. Chains of Subjugation: snare + schade op iedereen — groeps-defensive. Leeching Void: healing absorb op random speler — dispel.",en:"CC-immune. Chains of Subjugation: snare + damage on everyone — group defensive. Leeching Void: healing absorb on random player — dispel.",da:"CC-immun. Chains of Subjugation: snare + skade på alle — gruppe-defensive. Leeching Void: healing-absorb på tilfældig spiller — dispel."}},
      {mob:"Dark Conjuror",tags:["int","stop"],tip:{nl:"Summon Voidcaller: interrupt ELKE cast — genereert CC-immune Voidcallers. Umbral Bolt: spare interrupts.",en:"Summon Voidcaller: interrupt EVERY cast — generates CC-immune Voidcallers. Umbral Bolt: spare interrupts.",da:"Summon Voidcaller: afbryd HVERT cast — genererer CC-immune Voidcallers. Umbral Bolt: spare interrupts."}},
      {mob:"Bound Voidcaller",tags:["tank","stop"],tip:{nl:"Pulsing Void: constante groeps-AoE — kill zo snel mogelijk.",en:"Pulsing Void: constant group AoE — kill as fast as possible.",da:"Pulsing Void: konstant gruppe-AoE — dræb så hurtigt som muligt."}},
      {mob:"Shadowguard Champion",tags:["purge","tank"],tip:{nl:"Battle Rage: enrage — sooth. Relentless Pursuit: stapelende charges als de tank uit melee loopt — blijf in melee.",en:"Battle Rage: enrage — sooth. Relentless Pursuit: stacking charges if tank leaves melee — stay in melee.",da:"Battle Rage: enrage — sooth. Relentless Pursuit: stablende charges hvis tank forlader melee — forbliv i melee."}},
      {mob:"Rift Warden",tags:["tank","purge"],tip:{nl:"CC-immuun. Stabilize: blijf binnen 30 yards — anders enorme explosie! Rift Essence: magic debuff — dispel. Void Expulsion: AoE + swirly — dodge.",en:"CC-immune. Stabilize: stay within 30 yards — otherwise massive explosion! Rift Essence: magic debuff — dispel. Void Expulsion: AoE + swirlies — dodge.",da:"CC-immun. Stabilize: forbliv inden for 30 yards — ellers massiv eksplosion! Rift Essence: magic debuff — dispel. Void Expulsion: AoE + swirlies — undgå."}},
      {mob:"Ruthless Riftstalker",tags:["int","stop"],tip:{nl:"Shadowmend: interrupt. Backstab: teleport achter random speler — defensive als getarget.",en:"Shadowmend: interrupt. Backstab: teleports behind random player — defensive if targeted.",da:"Shadowmend: afbryd. Backstab: teleporterer bag tilfældig spiller — defensive hvis målrettet."}},
      {mob:"Void-Infused Destroyer",tags:["tank","avoid"],tip:{nl:"CC-immuun. Eruption: DoT op 2 spelers — iets spreiden. Void Cleave: frontal op random speler — stap opzij.",en:"CC-immune. Eruption: DoT on 2 players — spread slightly. Void Cleave: frontal on random player — step to the side.",da:"CC-immun. Eruption: DoT på 2 spillere — spred jer lidt. Void Cleave: frontal på tilfældig spiller — træd til siden."}},
      {mob:"Grand Shadow-Weaver",tags:["avoid","stop"],tip:{nl:"CC-immuun. Umbral Waves (Gates of the Abyss): dodge. Void Infusion: channel op random speler — drop combat of defensive.",en:"CC-immune. Umbral Waves (Gates of the Abyss): dodge. Void Infusion: channels on random player — drop combat or defensive.",da:"CC-immun. Umbral Waves (Gates of the Abyss): undgå. Void Infusion: channel på tilfældig spiller — drop kamp eller defensive."}}
    ],
    mdt:true, kg_url:"https://keystone.guru/routes/expansion/midnight/season/1"
  }
},
...
// ──────────────────────────────────────────────
{
  ...
  route:{
    ...
    trash:[
      {mob:"Skyreach Arcanologist",tags:["int","avoid"],tip:{nl:"Rune of Power: interrupt. Arcane Smash: frontal kegel — stap opzij.",en:"Rune of Power: interrupt. Arcane Smash: frontal cone — step to the side.",da:"Rune of Power: afbryd. Arcane Smash: frontal kegle — træd til siden."}},
      {mob:"Skyreach Blood-Sage",tags:["int"],tip:{nl:"Healing Sphere: interrupt. Healer mob — altijd first focus.",en:"Healing Sphere: interrupt. Healer mob — always focus first.",da:"Healing Sphere: afbryd. Healer mob — altid focus først."}},
      {mob:"Life-Pact Familiar",tags:["stop"],tip:{nl:"Life-Pact: healt ALLE andere mobs tot vol bij zijn dood — ALTIJD als eerste doden!",en:"Life-Pact: heals ALL other mobs to full on death — ALWAYS kill this first!",da:"Life-Pact: healer ALLE andre mobs til fuld ved dens død — DRÆB ALTID DENNE FØRST!"}},
      {mob:"Solar Construct Prototype",tags:["stop","tank"],tip:{nl:"Energize: beam richting Araknath die hem healt — stap IN de beam om te blokkeren (schade op jezelf). Essentieel bij Araknath!",en:"Energize: beam toward Araknath that heals him — step INTO the beam to block it (damage to yourself). Essential at Araknath boss!",da:"Energize: beam mod Araknath der healer ham — træd IND I beamen for at blokere (skade på dig selv). Essentielt ved Araknath boss!"}},
      {mob:"Skyreach Sun Talon",tags:["int","purge"],tip:{nl:"Rushing Winds: enrage buff — purge. Dire Screech: AoE channel — interrupt of snel doden.",en:"Rushing Winds: enrage buff — purge. Dire Screech: AoE channel — interrupt or kill fast.",da:"Rushing Winds: enrage buff — purge. Dire Screech: AoE channel — afbryd eller dræb hurtigt."}},
      {mob:"Skyreach Defender",tags:["avoid","int"],tip:{nl:"Repel: AoE knockback — defensive of rug naar muur. Focus Interrupt: interrupt zijn cast.",en:"Repel: AoE knockback — defensive or back to wall. Focus Interrupt: interrupt his cast.",da:"Repel: AoE knockback — defensive eller ryg mod væg. Focus Interrupt: afbryd hans cast."}},
      {mob:"Dread Raven",tags:["tank","avoid"],tip:{nl:"Patrouille. Charging Buffet: charge naar tank + knockback — staan in het centrum van het platform.",en:"Patrol mob. Charging Buffet: charges tank + knockback — stand in the center of the platform.",da:"Patrulje-mob. Charging Buffet: charge mod tank + knockback — stå i midten af platformen."}}
    ],
    mdt:true, kg_url:"https://keystone.guru/routes/expansion/midnight/season/1"
  }
},
