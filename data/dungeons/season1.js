...
// ──────────────────────────────────────────────
{
  ...
  tips:[
    {title:{nl:"Snelste S1-dungeon",en:"Fastest S1 dungeon"},
     text:{nl:"Slechts 3 bazen — ideaal voor tijdbeheer bij hoge keys.",en:"Only 3 bosses — ideal for time management on high keys."}},
    {title:{nl:"Loot highlight",en:"Loot highlight"},
     text:{nl:"Ringen, healer-trinket, dolk — erg gewild in Seizoen 1.",en:"Rings, healer trinket, dagger — highly sought after in Season 1."}}
  ],
  bosses:[
    ...
    {name:"Lothraxion",num:3,
     desc:{nl:"Naaru-wezen verblind door verraad. Divine Guile (100 energie): Lothraxion verdwijnt tussen klonen — vind de echte (GEEN gele hoorns!) en interrupt hem. Searing Rend = zware tankbuster. Brilliant Dispersion = AoE op meerdere spelers.",en:"Naaru entity blinded by betrayal. Divine Guile (100 energy): Lothraxion hides among clones — find the real one (NO yellow horns!) and interrupt him. Searing Rend = heavy tank buster. Brilliant Dispersion = AoE on multiple players."},
     tank:{nl:["Searing Rend = grote tankbuster + Radiant Scars debuff. Grote defensive hier.","Divine Guile (100 energie): Lothraxion verdwijnt. Fractured Images verschijnen — ze doen Mirrored Rend als je te dicht bij staat. Interrupt de ECHTE Lothraxion (geen gele hoorns).","Core Exposure als je de verkeerde interruptt = grote raidschade. Elke foute poging stapelt."],en:["Searing Rend = large tank buster + Radiant Scars debuff. Major defensive here.","Divine Guile (100 energy): Lothraxion disappears. Fractured Images appear — they do Mirrored Rend if you stand too close. Interrupt the REAL Lothraxion (no yellow horns).","Core Exposure if you interrupt the wrong one = major raid damage. Each wrong attempt stacks."]},
     heal:{nl:["Brilliant Dispersion = AoE schade op meerdere spelers tegelijk — raidcooldown paraat.","Divine Guile-fase: Fractured Images doen Mirrored Rend als spelers er te dicht bij staan — herinner mensen afstand te houden.","Searing Rend op tank = grote spike, Radiant Scars debuff — tank is prioriteit."],en:["Brilliant Dispersion = AoE damage on multiple players simultaneously — have raid cooldown ready.","Divine Guile phase: Fractured Images do Mirrored Rend if players stand too close — remind people to keep distance.","Searing Rend on tank = large spike, Radiant Scars debuff — tank is priority."]},
     dps:{nl:["Divine Guile (100 energie): Lothraxion verdwijnt tussen klonen. Kijk wie GEEN gele hoorns heeft = echte Lothraxion. Interrupt hem. Verkeerde interrupt = Core Exposure (stapelende raidschade).","Brilliant Dispersion: AoE op meerdere spelers — spreek af wie naar welke kant beweegt.","Fractured Images staan stil maar doen Mirrored Rend als je te dicht bij staat — houd afstand.","Offensive cooldowns syncen met Divine Guile — Lothraxion is vertraging kwetsbaar na de fase."],en:["Divine Guile (100 energy): Lothraxion vanishes among clones. Look for who has NO yellow horns = real Lothraxion. Interrupt him. Wrong interrupt = Core Exposure (stacking raid damage).","Brilliant Dispersion: AoE on multiple players — coordinate who moves which direction.","Fractured Images stand still but do Mirrored Rend if you stand too close — keep distance.","Sync offensive cooldowns with Divine Guile — Lothraxion is briefly vulnerable after the phase."]}}
  ],
  route:{
    summary:{nl:"Lineaire route — 3 bazen. Lust op pull 1, baas 2 en baas 3.",en:"Linear route — 3 bosses. Lust on pull 1, boss 2 and boss 3."},
    lust:[
      {moment:"Pull 1 — 🔥 BLOODLUST",uitleg:{nl:"Eerste grote pull",en:"First large pull"}},
      {moment:"Boss 2 — Nysarra 🔥",uitleg:{nl:"Tweede lust — burst venster",en:"Second lust — burst window"}},
      {moment:"Boss 3 — Lothraxion 🔥",uitleg:{nl:"Eindbaas — derde lust",en:"Final boss — third lust"}}
    ],
    pulls:[
      {label:{nl:"Pull 1 — 🔥 BLOODLUST",en:"Pull 1 — 🔥 BLOODLUST"},desc:{nl:"Eerste trashgroep. Lust hier.",en:"First trash group. Lust here."}},
      {label:{nl:"Baas 1 — Kasreth",en:"Boss 1 — Kasreth"},desc:{nl:"Adds doden. Energiebogen ontwijken.",en:"Kill adds. Dodge energy arcs."}},
      {label:{nl:"Baas 2 — Nysarra 🔥",en:"Boss 2 — Nysarra 🔥"},desc:{nl:"Bloodlust. Orbs vernietigen voor absorptie.",en:"Bloodlust. Destroy orbs before absorption."}},
      {label:{nl:"Baas 3 — Lothraxion 🔥",en:"Boss 3 — Lothraxion 🔥"},desc:{nl:"Eindbaas. Stack in lichtfase, spreid in void-fase.",en:"Final boss. Stack in light phase, spread in void phase."}}
    ],
    trash:[
      {mob:"Flux Engineer",tags:["avoid","tank"],tip:{nl:"Suppression Field: AoE op random speler — losjes spreiden, minimaal bewegen als getarget. Laat Mana Battery achter bij dood — direct vernietigen!",en:"Suppression Field: AoE on random player — loosely spread, minimal movement if targeted. Drops Mana Battery on death — destroy immediately!"}},
      {mob:"Circuit Seer",tags:["tank","stop"],tip:{nl:"CC-immuun. Arcing Mana: channel, defensive. Activeert Mana Batteries — switch en vernietig ze binnen 12 sec (Corespark Overload = raidwipe DoT).",en:"CC-immune. Arcing Mana: channel, defensive. Activates Mana Batteries — swap and destroy within 12s (Corespark Overload = raid wipe DoT)."}},
      {mob:"Nexus Adept",tags:["int"],tip:{nl:"Umbral Bolt: spare interrupts op deze mob.",en:"Umbral Bolt: use spare interrupts on this mob."}},
      {mob:"Cursed Voidcaller",tags:["int"],tip:{nl:"Creeping Void: interrupt. Zware caster — prioriteit bij grotere pulls.",en:"Creeping Void: interrupt. Heavy caster — priority target in larger pulls."}},
      {mob:"Dreadflail",tags:["tank","stop"],tip:{nl:"Tough mob. Void Lash: tank cleave. Flailstorm: groeps-AoE — defensives.",en:"Tough mob. Void Lash: tank cleave. Flailstorm: group AoE — defensives."}},
      {mob:"Grand Nullifier",tags:["int","avoid"],tip:{nl:"Nascent Energy: grote AoE — interrupt. Nullify: interrupt of tank defensive.",en:"Nascent Energy: large AoE — interrupt. Nullify: interrupt or tank defensive."}},
      {mob:"Null Sentinel",tags:["int","stop"],tip:{nl:"Tough mob. Nullwark Blast: interrupt. Dreadbellow: interrupt — anders groepsschade.",en:"Tough mob. Nullwark Blast: interrupt. Dreadbellow: interrupt — otherwise group damage."}},
      {mob:"Flarebat",tags:["purge","avoid"],tip:{nl:"Holy Echo buff bij dood: AoE-zone + healt vijanden — purge als mogelijk vóór dood. Radiant Swarm: fixate op random speler — kite weg.",en:"Holy Echo buff on death: AoE zone + heals enemies — purge before death if possible. Radiant Swarm: fixates random player — kite away."}},
      {mob:"Lightwrought",tags:["int","purge"],tip:{nl:"Holy Bolt: interrupt. Burning Radiance: magic debuff op 2 spelers — dispel direct.",en:"Holy Bolt: interrupt. Burning Radiance: magic debuff on 2 players — dispel immediately."}},
...
// ──────────────────────────────────────────────
{
  ...
  bosses:[
    ...
    {name:"Scourgelord Tyrannus",num:3,
     desc:{nl:"Eindbaas op zijn drake Rimefang. Op pull: Bone Infusion spawnt Infused Bone Piles. Rime Blast-debuff = gebruik het om Bone Piles te vernietigen. Army of the Dead bij lage HP = Bone Piles spawnen adds.",en:"Final boss on his drake Rimefang. On pull: Bone Infusion spawns Infused Bone Piles. Rime Blast debuff = use it to destroy Bone Piles. Army of the Dead at low HP = Bone Piles spawn adds."},
     tank:{nl:["Scourgelord's Brand = grote tankbuster. Grote defensive hier.","Rimefang (de drake) gebruikt Frost Spit + Ice Barrage — threat op Rimefang houden.","Keer de boss weg voor Rotting Strikes (melee-disease debuff op tank)."],en:["Scourgelord's Brand = large tank buster. Major defensive here.","Rimefang (the drake) uses Frost Spit + Ice Barrage — maintain threat on Rimefang.","Face boss away for Rotting Strikes (melee disease debuff on tank)."]},
     heal:{nl:["Rime Blast debuff op meerdere spelers = frost schade + verslangzaming. Spelers moeten naar een Bone Pile lopen voor het afloopt.","Army of the Dead (lage HP): Bone Piles spawnen adds — grote raidcooldown.","Festering Pulse = AoE disease DoT — steady healen."],en:["Rime Blast debuff on multiple players = frost damage + slow. Players must walk to a Bone Pile before it expires.","Army of the Dead (low HP): Bone Piles spawn adds — major raid cooldown.","Festering Pulse = AoE disease DoT — steady healing."]},
     dps:{nl:["Rime Blast debuff: loop snel naar een Infused Bone Pile en vernietig hem — anders explodeert de pile later als add.","Army of the Dead (lage HP): alle beschikbare DPS cooldowns gebruiken op de spawning adds.","Bone Piles op de juiste plekken houden — Rime Blast-spelers hebben er toegang tot nodig."],en:["Rime Blast debuff: quickly walk to an Infused Bone Pile and destroy it — otherwise the pile later spawns as an add.","Army of the Dead (low HP): use all available DPS cooldowns on spawning adds.","Keep Bone Piles in accessible positions — Rime Blast players need to reach them."]}}
  ],
  route:{
    summary:{nl:"Lineaire route omhoog door de mijn. Drie bazen. Lust op Scourgelord Tyrannus.",en:"Linear route upward through the mine. Three bosses. Lust on Scourgelord Tyrannus."},
    pulls:[
      {type:"trash",label:"Mijnschacht",area:"Pit of Saron",desc:{nl:"Begin trash richting Garfrost — pas op voor patrollerende packs.",en:"Opening trash toward Garfrost — watch patrolling packs."},lust:false},
      {type:"boss",label:"Forgemaster Garfrost",area:"Pit of Saron",desc:{nl:"Ore Chunks voor LoS bij Glacial Overload.",en:"Ore Chunks for LoS during Glacial Overload."},lust:false},
      {type:"trash",label:"Grotcorridor",area:"Pit of Saron",desc:{nl:"Pad naar Ick & Krick — grotere packs, niet overpullen.",en:"Path to Ick & Krick — bigger packs, don't overpull."},lust:false},
      {type:"boss",label:"Ick and Krick",area:"Pit of Saron",desc:{nl:"Bewegelijk gevecht. Ren weg van Toxic Waste.",en:"Mobile fight. Run away from Toxic Waste."},lust:false},
      {type:"trash",label:"Opgang",area:"Pit of Saron",desc:{nl:"Laatste stuk — pak trash voor % onderweg.",en:"Final stretch — collect trash for % on the way."},lust:false},
      {type:"boss",label:"Scourgelord Tyrannus",area:"Pit of Saron",desc:{nl:"Eindbaas. Heel Overlord's Brand. Lust hier.",en:"Final boss. Heal Overlord's Brand. Lust here."},lust:true}
    ],
    lust:[{moment:"Scourgelord Tyrannus",uitleg:{nl:"Meteen bij de pull.",en:"Immediately on pull."}}],
    trash:[
      {mob:"Ymirjar Graveblade",tags:["tank","int"],tip:{nl:"Frostbane Slash: tank debuff (+100% frost schade, stapelend). Icy Blast: interrupt — one-shot bij hoge stacks. Dark Rupture: AoE swirly — dodge.",en:"Frostbane Slash: tank debuff (+100% frost damage, stacking). Icy Blast: interrupt — one-shot at high stacks. Dark Rupture: AoE swirly — dodge."}},
      {mob:"Gloombound Shadebringer",tags:["int"],tip:{nl:"Shadow Bolt: interrupt. Rotting Strikes: melee-aanvallen geven tank een disease debuff die max HP verlaagt per stack — dispel prioriteit.",en:"Shadow Bolt: interrupt. Rotting Strikes: melee attacks apply a disease debuff that reduces tank max HP per stack — dispel priority."}},
      {mob:"Dreadpulse Lich",tags:["int","stop"],tip:{nl:"Icy Blast: interrupt ELKE cast. Torrent of Misery: channel, steeds zwaarder — CC of interrupt. Onder 50% HP: Dread Pulse = constante AoE tot dood. Vanish/Feign Death om combat te droppen.",en:"Icy Blast: interrupt EVERY cast. Torrent of Misery: channel, ramps up — CC or interrupt. Below 50% HP: Dread Pulse = constant AoE until dead. Vanish/Feign Death to drop combat."}},
      {mob:"Iceborn Proto-Drake",tags:["avoid","tank"],tip:{nl:"Frost Breath: frontal kegel op random speler — spreid losjes. Icy Strikes: extra frost schade op melee. Dood de Ymirjar-berijder eerst — die geeft Frostbane Slash debuff.",en:"Frost Breath: frontal cone on random player — loosely spread. Icy Strikes: extra frost damage on melee. Kill the Ymirjar rider first — they apply Frostbane Slash debuff."}},
      {mob:"Plungetalon Gargoyle",tags:["stop","tank"],tip:{nl:"Stoneskin buff: 99% schade-reductie van voren — ALTIJD van achteren aanvallen! Plungegrip: abductie — interrupt of drop combat.",en:"Stoneskin buff: 99% damage reduction from the front — ALWAYS attack from behind! Plungegrip: abduction — interrupt or drop combat."}},
      {mob:"Glacieth",tags:["avoid","tank"],tip:{nl:"Tough mob. Cryoburst: AoE plas onder alle spelers — losjes spreiden. Focused Guard: schild van voren, aanvallen van achteren voor gegarandeerde crits. Cryopatch: ijsplassen op de grond.",en:"Tough mob. Cryoburst: AoE puddle under all players — loosely spread. Focused Guard: frontal shield, attack from behind for guaranteed crits. Cryopatch: ice puddles on the ground."}},
      {mob:"Scourge Plaguespreader",tags:["int","stop"],tip:{nl:"Verschijnt tijdens Army of the Dead (Tyrannus lage HP). Interrupt hun cast — als het doorgaat = extra raid-schade. Hoge prioriteit.",en:"Appears during Army of the Dead (Tyrannus low HP). Interrupt their cast — if it goes through = extra raid damage. High priority."}},
...
// ──────────────────────────────────────────────
{
  ...
  bosses:[
    ...
    {name:"L'ura",num:4,
     ...
     heal:{nl:["Fase 1: Naaru's Lament = constante raidschade terwijl portals open zijn.","Fase 2: Notes of Despair = constante AoE schade die stapelt via Anguish debuff. Discordant Beams silencen Notes zo snel mogelijk.","Grim Chorus = Notes shufflen + grote AoE — raidcooldown."],en:["Phase 1: Naaru's Lament = constant raid damage while portals are open.","Phase 2: Notes of Despair = constant AoE damage stacking via Anguish debuff. Discordant Beams silence Notes as fast as possible.","Grim Chorus = Notes shuffle + large AoE — raid cooldown."]},
     dps:{nl:["Fase 1: Rift Wardens (2 golven) SNEL doden — elke kill = Alleria stunt L'ura voor 12 sec + 3x schade window. Lust in dit window.","Fase 2: Discordant Beam op jou = richt je op een Note of Despair om het te silencen. Coördineer wie welke Note treft.","Grim Chorus: grote AoE als Notes niet tijdig gesilenced zijn — stack naar kant van de ruimte."],en:["Phase 1: Rift Wardens (2 waves) kill FAST — each kill = Alleria stuns L'ura for 12 sec + 3x damage window. Lust in this window.","Phase 2: Discordant Beam on you = aim at a Note of Despair to silence it. Coordinate who hits which Note.","Grim Chorus: large AoE if Notes not silenced in time — stack toward the side of the room."]}}
  ],
  route:{
    summary:{nl:"Lineaire route — Triad's Conservatory → Shadowguard Incursion → Seat. Vier bazen. Lust op L'ura.",en:"Linear route — Triad's Conservatory → Shadowguard Incursion → Seat. Four bosses. Lust on L'ura."},
    pulls:[
      {type:"trash",label:"Triad's Conservatory",area:"Triad's Conservatory",desc:{nl:"Eerste sectie. Pull richting Zuraal.",en:"First section. Pull toward Zuraal."},lust:false},
      {type:"boss",label:"Zuraal the Ascended",area:"Triad's Conservatory",desc:{nl:"Sta niet in Darkfathom-pilaren.",en:"Don't stand in Darkfathom pillars."},lust:false},
      {type:"trash",label:"Shadowguard Incursion",area:"Shadowguard Incursion",desc:{nl:"Grote packs — voorzichtig pakken.",en:"Large packs — careful pulling."},lust:false},
      {type:"boss",label:"Saprish",area:"Shadowguard Incursion",desc:{nl:"Dood Shadewing eerst.",en:"Kill Shadewing first."},lust:false},
      {type:"boss",label:"Viceroy Nezhar",area:"Shadowguard Incursion",desc:{nl:"Entropic Force interrupt. Tentakels snel doden.",en:"Interrupt Entropic Force. Kill tentacles fast."},lust:false},
      {type:"boss",label:"L'ura",area:"Seat of the Triumvirate",desc:{nl:"Eindbaas. Rift Wardens snel doden. Lust in 3x schade window.",en:"Final boss. Kill Rift Wardens fast. Lust in 3x damage window."},lust:true}
    ],
    lust:[{moment:"L'ura — Rift Warden kill",uitleg:{nl:"Eerste Rift Warden kill — Alleria stunt L'ura + 3x schade.",en:"First Rift Warden kill — Alleria stuns L'ura + 3x damage."}}],
    trash:[
      ...
      {mob:"Dark Conjuror",tags:["int","stop"],tip:{nl:"Summon Voidcaller: interrupt ELKE cast — genereert CC-immune Voidcallers. Umbral Bolt: spare interrupts.",en:"Summon Voidcaller: interrupt EVERY cast — generates CC-immune Voidcallers. Umbral Bolt: spare interrupts."}},
      {mob:"Bound Voidcaller",tags:["tank","stop"],tip:{nl:"Pulsing Void: constante groeps-AoE — kill zo snel mogelijk.",en:"Pulsing Void: constant group AoE — kill as fast as possible."}},
      {mob:"Shadowguard Champion",tags:["purge","tank"],tip:{nl:"Battle Rage: enrage — sooth. Relentless Pursuit: stapelende charges als de tank uit melee loopt — blijf in melee.",en:"Battle Rage: enrage — sooth. Relentless Pursuit: stacking charges if tank leaves melee — stay in melee."}},
      {mob:"Rift Warden",tags:["tank","purge"],tip:{nl:"CC-immuun. Stabilize: blijf binnen 30 yards — anders enorme explosie! Rift Essence: magic debuff — dispel. Void Expulsion: AoE + swirly — dodge.",en:"CC-immune. Stabilize: stay within 30 yards — otherwise massive explosion! Rift Essence: magic debuff — dispel. Void Expulsion: AoE + swirlies — dodge."}},
      {mob:"Ruthless Riftstalker",tags:["int","stop"],tip:{nl:"Shadowmend: interrupt. Backstab: teleport achter random speler — defensive als getarget.",en:"Shadowmend: interrupt. Backstab: teleports behind random player — defensive if targeted."}},
      {mob:"Void-Infused Destroyer",tags:["tank","avoid"],tip:{nl:"CC-immuun. Eruption: DoT op 2 spelers — iets spreiden. Void Cleave: frontal op random speler — stap opzij.",en:"CC-immune. Eruption: DoT on 2 players — spread slightly. Void Cleave: frontal on random player — step to the side."}},
...
// ──────────────────────────────────────────────
{
  ...
  time:"30 min",
  lore:{nl:"Het hoogste punt van de Arakkoa-vesting. Windmagie en gevaarlijke Arakkoa-krijgers bewaken de top.",en:"The highest point of the Arakkoa fortress. Wind magic and dangerous Arakkoa warriors guard the summit."},
  tips:[
    {title:{nl:"Ingang",en:"Entrance"},text:{nl:"Via The Timeways in Silvermoon in Season 1.",en:"Via The Timeways in Silvermoon in Season 1."}}
  ],
  bosses:[
  ...
  route:{
    ...
    pulls:[
      ...
      {type:"trash",label:"Grand Spire binnenring",area:"Grand Spire",desc:{nl:"Packs op de binnenring richting Araknath.",en:"Packs on the inner ring toward Araknath."},lust:false},
    ...
    trash:[
      {mob:"Skyreach Arcanologist",tags:["int","avoid"],tip:{nl:"Rune of Power: interrupt. Arcane Smash: frontal kegel — stap opzij.",en:"Rune of Power: interrupt. Arcane Smash: frontal cone — step to the side."}},
      {mob:"Skyreach Blood-Sage",tags:["int"],tip:{nl:"Healing Sphere: interrupt. Healer mob — altijd first focus.",en:"Healing Sphere: interrupt. Healer mob — always focus first."}},
      {mob:"Life-Pact Familiar",tags:["stop"],tip:{nl:"Life-Pact: healt ALLE andere mobs tot vol bij zijn dood — ALTIJD als eerste doden!",en:"Life-Pact: heals ALL other mobs to full on death — ALWAYS kill this first!"}},
      {mob:"Solar Construct Prototype",tags:["stop","tank"],tip:{nl:"Energize: beam richting Araknath die hem healt — stap IN de beam om te blokkeren (schade op jezelf). Essentieel bij Araknath!",en:"Energize: beam toward Araknath that heals him — step INTO the beam to block it (damage to yourself). Essential at Araknath boss!"}},
      {mob:"Skyreach Sun Talon",tags:["int","purge"],tip:{nl:"Rushing Winds: enrage buff — purge. Dire Screech: AoE channel — interrupt of snel doden.",en:"Rushing Winds: enrage buff — purge. Dire Screech: AoE channel — interrupt or kill fast."}},
      {mob:"Skyreach Defender",tags:["avoid","int"],tip:{nl:"Repel: AoE knockback — defensive of rug naar muur. Focus Interrupt: interrupt zijn cast.",en:"Repel: AoE knockback — defensive or back to wall. Focus Interrupt: interrupt his cast."}},
...
// ──────────────────────────────────────────────
{
  ...
  ,
    ...
    {name:"Lithiel Cinderfury",num:4,
     desc:{nl:"Eindbaas. Fingers of Gul'dan: Wild Imps spawnen bij alle spelers. Daarna Demonic Gateway + Malefic Wave — LOOP DOOR HET GATEWAY voor immuniteit. Chaos Bolt = interrupt. Demons door de Wave = 100% haste.",en:"Final boss. Fingers of Gul'dan: Wild Imps spawn near all players. Then Demonic Gateway + Malefic Wave — WALK THROUGH THE GATEWAY for immunity. Chaos Bolt = interrupt. Demons hit by Wave = 100% haste."},
  ...
  route:{
    summary:{nl:"Lineaire dungeon. Geen M+-versie. Lust op eindbaas Lithiel.",en:"Linear dungeon. No M+ version. Lust on final boss Lithiel."},
    lust:[{moment:"Boss 4 — Lithiel Cinderfury 🔥",uitleg:{nl:"Eindbaas — Bloodlust hier",en:"Final boss — Bloodlust here"}}],
    pulls:[
      ...
      {label:{nl:"Baas 1 — Kystia",en:"Boss 1 — Kystia"},desc:{nl:"Kanalen onderbreken. Niet in plassen staan.",en:"Interrupt channels. Avoid puddles."}},
      {label:{nl:"Baas 2 — Zaen",en:"Boss 2 — Zaen"},desc:{nl:"Adds direct doden.",en:"Kill adds immediately."}},
      {label:{nl:"Baas 3 — Xathuux",en:"Boss 3 — Xathuux"},desc:{nl:"Tank defensives inzetten. Kleine demonen snel doden.",en:"Use tank defensives. Kill small demons fast."}},
      {label:{nl:"Baas 4 — Lithiel 🔥",en:"Boss 4 — Lithiel 🔥"},desc:{nl:"Eindbaas. Fel-empowerment altijd onderbreken. Lust hier.",en:"Final boss. Always interrupt fel empowerment. Lust here."}}
    ],
    trash:[
...
// ──────────────────────────────────────────────
{
  ...
  tips:[
    ...
    {title:{nl:"Ingangcoördinaten",en:"Entrance coordinates"},
     text:{nl:"/way 26.4, 78.1 — Harandar, volg de Lightbloom Roots-quest.",en:"/way 26.4, 78.1 — Harandar, follow the Lightbloom Roots quest."}}
  ],
  bosses:[
    {name:"Meittik",num:1,
...
// ──────────────────────────────────────────────
{
  ...
  tips:[
    {title:{nl:"Ingangcoördinaten",en:"Entrance coordinates"},
     text:{nl:"/way 29.7, 84.9 — Zul'Aman.",en:"/way 29.7, 84.9 — Zul'Aman."}},
