...
const WINDRUNNER_SPIRE = {
  ...
  bosses:[
    {name:"Emberdawn",num:1,
     ...
     tank:{nl:["Defensieve op Searing Beak — de klap én DoT stapelen gevaarlijk.","Blijf dicht bij de boss tijdens Burning Gale om onnodig bewegen te voorkomen."],en:["Use a defensive on Searing Beak — the hit and DoT stack dangerously.","Stay close to the boss during Burning Gale to avoid unnecessary movement."]},
    ...
    {name:"The Restless Heart",num:4,
     ...
     tank:{nl:["Geen specifieke tank-mechanic — positioneer de boss stabiel in het midden.","Ontwijkt de uitdijende Billowing Wind-ring zodra die spawnt."],en:["No dedicated tank mechanic — keep the boss positioned stably in the center.","Dodge the expanding Billowing Wind ring as soon as it spawns."]},
  ...
  route:{
    ...
    lust:[
      ...
      {moment:"Boss 4 — The Restless Heart 🔥",uitleg:{nl:"Final boss — tweede Bloodlust",en:"Final boss — second Bloodlust"}}
    ],
    pulls:[
      ...
      {label:{nl:"Boss 1 — Emberdawn",en:"Boss 1 — Emberdawn"},desc:{nl:"Plassen neerleggen aan de rand bij Updraft.",en:"Place puddles at the edges during Updraft."}},
      ...
      {label:{nl:"Boss 2 — Derelict Duo 🔥",en:"Boss 2 — Derelict Duo 🔥"},desc:{nl:"Bloodlust. Both bosses gelijkmatig doden.",en:"Bloodlust. Kill both bosses simultaneously."}},
      ...
      {label:{nl:"Boss 3 — Kroluk",en:"Boss 3 — Kroluk"},desc:{nl:"Bewaar defensives voor 66%/33% add-fasen.",en:"Save defensives for the 66%/33% add phases."}},
      {label:{nl:"Boss 4 — The Restless Heart 🔥",en:"Boss 4 — The Restless Heart 🔥"},desc:{nl:"Final boss. Lust hier als beschikbaar.",en:"Final boss. Lust here if available."}}
    ],
    trash:[
      ...
      {mob:"Storming Soulfont",tags:["stop"],tip:{nl:"Geeft energie aan The Restless Heart als hij lang leeft — CC of kill snel. Gust Shot van de boss vernietigt Soulfonts.",en:"Feeds energy to The Restless Heart if it lives long — CC or kill fast. Gust Shot from Restless Heart destroys Soulfonts."}}
    ],
  ...
  tank_pathing: {
    pulls: [
      ...
      { pullRef: 2, danger: 5, mobs: ["Emberdawn"],
        note: { nl: "Boss 1: Flaming Updraft in hoek leggen; Burning Gale + Searing Beak — tank hoekpositie.", en: "Boss 1: drop Flaming Updraft in a corner; Burning Gale + Searing Beak — tank in a corner." },
      ...
      { pullRef: 4, danger: 5, mobs: ["Kalis", "Latch"],
        note: { nl: "Two bosses tegelijk dood: Kalis Shadow Bolt; Debilitating Shriek via Latch Heaving Yank (Icy Veins).", en: "Kill both bosses together: interrupt Kalis's Shadow Bolt; Debilitating Shriek stopped via Latch's Heaving Yank (Icy Veins)." },
      ...
      { pullRef: 6, danger: 5, mobs: ["Commander Kroluk"],
        note: { nl: "Boss 3: Rampage defensive; 66%/33% adds stacken voor cleave; Intimidating Shout stacken.", en: "Boss 3: defensive for Rampage; stack adds at 66%/33% for cleave; stack for Intimidating Shout." },
      ...
      { pullRef: 7, danger: 5, mobs: ["The Restless Heart"],
        note: { nl: "Final boss: Tempest Slash mitigation; Turbulent Arrows / Billowing Wind (Icy Veins).", en: "Final boss: mitigate Tempest Slash; Turbulent Arrows / Billowing Wind (Icy Veins)." },
