...
const NEXUS_POINT_XENAS = {
  ...
  tips:[
    {title:{nl:"Snelste S1-dungeon",en:"Fastest S1 dungeon"},
     text:{nl:"Slechts 3 bosses — ideaal voor tijdbeheer bij hoge keys.",en:"Only 3 bosses — ideal for time management on high keys."}},
  ...
  route:{
    summary:{nl:"Lineaire route — 3 bosses. Lust op pull 1, boss 2 en boss 3.",en:"Linear route — 3 bosses. Lust on pull 1, boss 2 and boss 3."},
    lust:[
      ...
      {moment:"Boss 3 — Lothraxion 🔥",uitleg:{nl:"Final boss — derde lust",en:"Final boss — third lust"}}
    ],
    pulls:[
      {label:{nl:"Pull 1 — 🔥 BLOODLUST",en:"Pull 1 — 🔥 BLOODLUST"},desc:{nl:"Eerste trashgroep. Lust hier.",en:"First trash group. Lust here."}},
      {label:{nl:"Boss 1 — Kasreth",en:"Boss 1 — Kasreth"},desc:{nl:"Adds doden. Energiebogen ontwijken.",en:"Kill adds. Dodge energy arcs."}},
      {label:{nl:"Boss 2 — Nysarra 🔥",en:"Boss 2 — Nysarra 🔥"},desc:{nl:"Bloodlust. Orbs vernietigen voor absorptie.",en:"Bloodlust. Destroy orbs before absorption."}},
      {label:{nl:"Boss 3 — Lothraxion 🔥",en:"Boss 3 — Lothraxion 🔥"},desc:{nl:"Final boss. Stack in lichtfase, spreid in void-fase.",en:"Final boss. Stack in light phase, spread in void phase."}}
    ],
    trash:[
  ...
  tank_pathing: {
    pulls: [
      ...
      { pullRef: 1, danger: 5, mobs: ["Chief Corewright Kasreth"],
        note: { nl: "Boss 1: adds + energiebogen; tank positie voor arc dodges.", en: "Boss 1: adds + energy arcs; tank position for dodges." },
      ...
      { pullRef: 2, danger: 5, mobs: ["Corewarden Nysarra"],
        note: { nl: "Boss 2 (lust): orbs absorberen/vernietigen vóór boss (route).", en: "Boss 2 (lust): destroy orbs before boss absorbs (route)." },
        interrupts: { nl: "Orb-fase > losse boss-casts roteren.", en: "Orb phase > rotate loose boss casts." } },
      { pullRef: 3, danger: 5, mobs: ["Lothraxion"],
        note: { nl: "Final boss: Divine Guile — echte Lothraxion heeft geen gele hoorns; verkeerde interrupt = Core Exposure (Icy Veins).", en: "Final boss: Divine Guile — real Lothraxion has no yellow horns; wrong interrupt = Core Exposure (Icy Veins)." },
        interrupts: { nl: "Divine Guile: alleen de echte boss interrupten na callout.", en: "Divine Guile: interrupt only the real boss after callout." } }
    ]
  }
};
