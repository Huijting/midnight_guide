...
const VOIDSCAR_ARENA = {
  ...
  tips:[
    ...
    {title:{nl:"Arena-indeling",en:"Arena layout"},
     text:{nl:"Gladiator-stijl — three bosses spawnen opeenvolgend. Herpositioneer tussen elk gevecht.",en:"Gladiator style — three bosses spawn sequentially. Reposition between each fight."}}
  ],
  bosses:[
    {name:"Taz'Rah",num:1,
    ...
    {name:"Atroxus",num:2,
     desc:{nl:"Uitgehongerd gedrocht. Searing Roar is een FRONTALE KEGEL met een dodelijk gif-DoT. Nooit voor deze boss staan.",en:"A starved monstrosity. Searing Roar is a FRONTAL CONE with a lethal poison DoT. Never stand in front of this boss."},
     ...
     dps:{nl:["KRITIEK: NOOIT voor Atroxus staan — Searing Roar is verwoestend.","Altijd achter of naast de boss staan.","Gifplassen op de grond zijn permanente gevaren.",],en:["CRITICAL: NEVER stand in front of Atroxus — Searing Roar is devastating.","Always stand behind or beside the boss.","Poison puddles on the ground are permanent hazards."]}},
    {name:"Charonus",num:3,
     desc:{nl:"Final boss en eigenaar van de arena. Unstable Singularity = void-zone die spelers aantrekt + slow. Gravitic Orbs jagen spelers — worden vernietigd als ze door een Unstable Singularity lopen. Condensed Mass = grote raid-AoE. Cosmic Blast = knockback + DoT.",en:"Final boss and arena owner. Unstable Singularity = void zone that pulls players + slow. Gravitic Orbs chase players — destroyed when they pass through an Unstable Singularity. Condensed Mass = large raid AoE. Cosmic Blast = knockback + DoT."},
     tank:{nl:["Cosmic Blast = knockback + shadow DoT op iedereen — defensive hier.","Unstable Singularity-zones aantrekken — niet erin staan tenzij je een Gravitic Orb leidt.","Positioneer de boss weg van de Singularity-zones zodat je niet teruggeslingerd wordt."],en:["Cosmic Blast = knockback + shadow DoT on everyone — defensive here.","Unstable Singularity zones pull players — don't stand in them unless guiding a Gravitic Orb.","Position the boss away from Singularity zones so you don't get knocked into them."]},
  ...
  route:{
    summary:{nl:"Gladiator-arena — three bosses opeenvolgend. Herpositioneer tussen elk gevecht. Lust op Charonus.",en:"Gladiator arena — three bosses in sequence. Reposition between each fight. Lust on Charonus."},
    lust:[{moment:"Boss 3 — Charonus 🔥",uitleg:{nl:"Final boss — Bloodlust hier",en:"Final boss — Bloodlust here"}}],
    pulls:[
      {label:{nl:"Boss 1 — Taz'Rah",en:"Boss 1 — Taz'Rah"},desc:{nl:"Dark Rift: shades clusteren en AoE-burnen.",en:"Dark Rift: cluster shades and AoE burn."}},
      {label:{nl:"Boss 2 — Atroxus",en:"Boss 2 — Atroxus"},desc:{nl:"NOOIT frontaal staan. Defensive op elke Searing Roar.",en:"NEVER stand frontal. Defensive on every Searing Roar."}},
      {label:{nl:"Boss 3 — Charonus 🔥",en:"Boss 3 — Charonus 🔥"},desc:{nl:"Versterkingen direct doden. Gepuppette spelers niet aanvallen. Lust hier.",en:"Kill reinforcements immediately. Don't attack puppeted players. Lust here."}}
    ],
    trash:[
