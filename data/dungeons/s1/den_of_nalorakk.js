...
const DEN_OF_NALORAKK = {
  ...
  bosses:[
    {name:"The Hoardmonger",num:1,
     ...
     tank:{nl:["Earthshatter Slam = grote frontale kegel — de boss ALTIJD van de groep afgewend houden.","Defensive bij versterkte Resourceful Measures-momenten."],en:["Earthshatter Slam = large frontal cone — ALWAYS keep the boss faced away from the group.","Use a defensive during empowered Resourceful Measures moments."]},
