...
const MAGISTERS_TERRACE = {
  ...
  bosses:[
    {name:"Arcanotron Custos",num:1,
     ...
     dps:{nl:["Soak Energy Orbs tijdens Refueling — maximum 2–3 per speler (te veel = Unstable Energy stacks).","Arcane Residue-plassen voorzichtig weglopen van de boss."],en:["Soak Energy Orbs during Refueling — maximum 2–3 per player (too many = Unstable Energy stacks).","Carefully walk Arcane Residue pools away from the boss."]}},
    ...
    {name:"Degentrius",num:4,
     desc:{nl:"Machtig Void-wezen dat de Terrace bestormt. Final boss van de Seizoen 1 M+-versie.",en:"A powerful void entity assaulting the Terrace. Final boss of the Season 1 M+ version."},
     tank:{nl:["Hulking Fragment = grote tankbuster — stap WEG van de groep (8 yard AoE).","Entropy Blast = magic hit + 30s DoT. Dispel jezelf weg van de boss om de plas buiten de groep te droppen.","Null Bomb spawnt na 4 soaks — de tank detoneert hem. Grote defensive klaar houden.","Void Torrent beams NIET aanraken — 5 sec stun."],en:["Hulking Fragment = large tank buster — step AWAY from the group (8 yard AoE).","Entropy Blast = magic hit + 30s DoT. Get dispelled away from the boss to drop the puddle outside the group.","Null Bomb spawns after 4 soaks — the tank detonates it. Have a major defensive ready.","Void Torrent beams do NOT touch — 5 sec stun."]},
  ...
  route:{
    summary:{nl:"Rechtstreeks door de Terrace. Pak de Arcane Tome buff na pull 1. Lust op pull 1, boss 2 en final boss.",en:"Straight through the Terrace. Grab the Arcane Tome buff after pull 1. Lust on pull 1, boss 2 and final boss."},
    lust:[
      ...
      {moment:"Boss 4 — Degentrius 🔥",uitleg:{nl:"Final boss — derde lust als beschikbaar",en:"Final boss — third lust if available"}}
    ],
    pulls:[
      ...
      {label:{nl:"Boss 1 — Arcanotron Custos",en:"Boss 1 — Arcanotron Custos"},desc:{nl:"Orb-soak verdelen. Max 3 per speler.",en:"Assign orb soaking. Max 3 per player."}},
      {label:{nl:"Boss 2 — Seranel Sunlash 🔥",en:"Boss 2 — Seranel Sunlash 🔥"},desc:{nl:"Bloodlust. Sta IN de Suppression Zone bij Wave of Silence.",en:"Bloodlust. Stand IN the Suppression Zone during Wave of Silence."}},
      {label:{nl:"Boss 3 — Gemellus",en:"Boss 3 — Gemellus"},desc:{nl:"Klonen direct focussen. Daarna boss burnen.",en:"Focus clones immediately. Then burn the boss."}},
      {label:{nl:"Boss 4 — Degentrius 🔥",en:"Boss 4 — Degentrius 🔥"},desc:{nl:"Final boss. Void-tentakels vernietigen. Lust als beschikbaar.",en:"Final boss. Destroy Void tentacles. Lust if available."}}
    ],
    trash:[
  ...
  tank_pathing: {
    pulls: [
      ...
      { pullRef: 2, danger: 5, mobs: ["Arcanotron Custos"],
        note: { nl: "Boss 1: positioneer voor Arcane Expulsion/knockback; soak Energy Orbs tijdens Refueling (max ~3 orbs per speler).", en: "Boss 1: position for Arcane Expulsion/knockback; soak Energy Orbs during Refueling (~3 orbs per player max)." },
      ...
      { pullRef: 3, danger: 5, mobs: ["Seranel Sunlash"],
        note: { nl: "Boss 2: Wave of Silence — iedereen IN Suppression Zone. Purge Hastening Ward op de boss. Runic Mark: één tegelijk naar zone.", en: "Boss 2: Wave of Silence — everyone IN Suppression Zone. Purge Hastening Ward. Runic Mark: one at a time into the zone." },
      ...
      { pullRef: 4, danger: 5, mobs: ["Gemellus"],
        note: { nl: "Boss 3: focus Void-klonen / Triplicate-kopieën; Neural Link naar juiste kopie (Icy Veins).", en: "Boss 3: focus Void clones / Triplicate copies; Neural Link to the correct copy per Icy Veins." },
      ...
      { pullRef: 5, danger: 5, mobs: ["Degentrius"],
        note: { nl: "Final boss: quadranten voor Unstable Void Essence; raak Void Torrent-stralen niet. Tank: Hulking Fragment uit de groep.", en: "Final boss: quadrants for Unstable Void Essence; never touch Void Torrent beams. Tank: Hulking Fragment away from group." },
