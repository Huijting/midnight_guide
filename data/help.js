...
const HELP_CONTENT = {
  ...
  nl: {
    ...
    sections: [
      ...
      { icon:'📋', title:'Changelog', text:'<strong>v7.5</strong> — 🏰 Raids sectie toegevoegd (The Dreamrift volledig uitgewerkt). ⚡ Affixes tab toegevoegd. Navigatie wrapping in 2 rijen op mobiel. Rotation fix (undefined teksten). Weekly Crafting Quest gecorrigeerd.<br><br><strong>v7.4</strong> — Talents tab (🌳) toegevoegd aan alle specs met links naar Icy Veins + Method.gg. Klassen alfabetisch gesorteerd. 8 spec-bestanden afgemaakt.<br><br><strong>v7.3</strong> — Alle /way coördinaten in Weeklies in-game geverifieerd en gecorrigeerd. KP Boom + KP Bronnen tabs toegevoegd aan Professies.<br><br><strong>v7.2</strong> — Specs sectie gelanceerd: 39 specs, 8 tabbladen per spec.<br><br><strong>v7.0</strong> — Profession KP-systeem compleet met alle 13 professies.' },
    ],
    close: '✕ Sluiten'
  },
  ...
  en: {
    ...
    sections: [
      ...
      { icon:'📋', title:'Changelog', text:'<strong>v7.5</strong> — 🏰 Raids section added (The Dreamrift fully worked out). ⚡ Affixes tab added. Navigation wraps to 2 rows on mobile. Rotation fix (undefined text). Weekly Crafting Quest corrected.<br><br><strong>v7.4</strong> — Talents tab (🌳) added to all specs with links to Icy Veins + Method.gg. Classes sorted alphabetically. 8 spec files completed.<br><br><strong>v7.3</strong> — All /way coordinates in Weeklies verified in-game and corrected. KP Tree + KP Sources tabs added to Professions.<br><br><strong>v7.2</strong> — Specs section launched: 39 specs, 8 tabs per spec.<br><br><strong>v7.0</strong> — Profession KP system complete with all 13 professions.' },
    ],
    close: '✕ Close'
  },
  ...
  da: {
    ...
    sections: [
      ...
      { icon:'📋', title:'Changelog', text:'<strong>v7.5</strong> — 🏰 Raids-sektion tilføjet (The Dreamrift fuldt udarbejdet). ⚡ Affixes-fane tilføjet. Navigation folder til 2 rækker på mobil. Rotation-fix (undefined tekst). Ugentlig Crafting Quest korrigeret.<br><br><strong>v7.4</strong> — Talents-fane (🌳) tilføjet til alle specs med links til Icy Veins + Method.gg. Klasser sorteret alfabetisk. 8 spec-filer fuldført.<br><br><strong>v7.3</strong> — Alle /way koordinater i Weeklies verificeret i spillet og korrigeret. KP Træ + KP Kilder-faner tilføjet til Professioner.<br><br><strong>v7.2</strong> — Specs-sektion lanceret: 39 specs, 8 faner per spec.<br><br><strong>v7.0</strong> — Profession KP-system komplet med alle 13 professioner.' },
    ],
    close: '✕ Luk'
  },
