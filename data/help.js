...
const HELP_CONTENT = {
  ...
  en: {
    ...
    sections: [
      ...
      { icon:'📋', title:'Changelog', text:'<strong>v7.7</strong> — 📖 Glossary added (16 terms explained for beginners). Glossary tab + inline gold tooltips in dungeon tips. Nysarra corrected: STAND IN the wound = YOU deal 300% more damage TO the boss. Nav tabs horizontally scrollable.<br><br><strong>v7.6</strong> — 🐉 Trash mob guide added to all 12 dungeons (69 mobs with interrupt/dodge/purge tags). All bosses of all 8 M+ dungeons thoroughly verified and corrected against Method.gg &amp; Icy Veins (incl. Seranel Sunlash, Degentrius, Algeth\'ar Academy, Pit of Saron, Seat of the Triumvirate, Skyreach fully rewritten).<br><br><strong>v7.5</strong> — 🏰 Raids section added (The Dreamrift fully worked out). ⚡ Affixes tab added. Navigation wraps to 2 rows on mobile. Rotation fix (undefined text). Weekly Crafting Quest corrected.<br><br><strong>v7.4</strong> — Talents tab (🌳) added to all specs with links to Icy Veins + Method.gg. Classes sorted alphabetically. 8 spec files completed.<br><br><strong>v7.3</strong> — All /way coordinates in Weeklies verified in-game and corrected. KP Tree + KP Sources tabs added to Professions.<br><br><strong>v7.2</strong> — Specs section launched: 39 specs, 8 tabs per spec.<br><br><strong>v7.0</strong> — Profession KP system complete with all 13 professions.' },
    ],
    close: '✕ Close'
  },
  ...
  da: {
    ...
    sections: [
      ...
      { icon:'🏰', title:'Raids', text:'Sæson 1 har 3 raids: The Dreamrift (1 boss — åbner 17. mar), The Voidspire (6 bosser — åbner 17. mar) og March on Quel\'Danas (2 bosser — åbner 31. mar). Voidspire og Dreamrift er nu fuldt udarbejdede med boss-taktikker per rolle. March on Quel\'Danas indeholder omni-tier-token (Chiming Void Curio) og Ashes of Belo\'ren føniks-mount på Mythic.' },
      ...
      { icon:'📋', title:'Changelog', text:'<strong>v7.7</strong> — 📖 Ordbog tilføjet (16 begreber forklaret for begyndere). Ordbog-fane + inline gyldne tooltips i dungeon-tips. Nysarra rettet: STÅ I såret = DU gør 300% mere skade PÅ bossen. Nav-faner vandret-scrollbare.<br><br><strong>v7.6</strong> — 🐉 Trash mob-guide tilføjet til alle 12 dungeons (69 mobs med interrupt/dodge/purge tags). Alle bosser i alle 8 M+ dungeons grundigt kontrolleret og rettet mod Method.gg &amp; Icy Veins (bl.a. Seranel Sunlash, Degentrius, Algeth\'ar Academy, Pit of Saron, Seat of the Triumvirate, Skyreach fuldstændigt omskrevet).<br><br><strong>v7.5</strong> — 🏰 Raids-sektion tilføjet (The Dreamrift fuldt udarbejdet). ⚡ Affixes-fane tilføjet. Navigation folder til 2 rækker på mobil. Rotation-fix (undefined tekst). Ugentlig Crafting Quest korrigeret.<br><br><strong>v7.4</strong> — Talents-fane (🌳) tilføjet til alle specs med links til Icy Veins + Method.gg. Klasser sorteret alfabetisk. 8 spec-filer fuldført.<br><br><strong>v7.3</strong> — Alle /way koordinater i Weeklies verificeret i spillet og korrigeret. KP Træ + KP Kilder-faner tilføjet til Professioner.<br><br><strong>v7.2</strong> — Specs-sektion lanceret: 39 specs, 8 faner per spec.<br><br><strong>v7.0</strong> — Profession KP-system komplet med alle 13 professioner.' },
    ],
    close: '✕ Luk'
  },
