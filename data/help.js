...
const HELP_CONTENT = {
  ...
  en: {
    ...
    sections: [
      ...
      { icon:'📋', title:'Changelog', text:'<strong>v7.5</strong> — Rotation tab fix (undefined text resolved), Weekly Crafting Quest reference corrected, help guide updated.<br><br><strong>v7.4</strong> — Talents tab (🌳) added to all specs with links to Icy Veins + Method.gg. Classes sorted alphabetically. 8 spec files completed.<br><br><strong>v7.3</strong> — All /way coordinates in Weeklies verified in-game and corrected. KP Tree + KP Sources tabs added to Professions.<br><br><strong>v7.2</strong> — Specs section launched: 39 specs, 8 tabs per spec.<br><br><strong>v7.0</strong> — Profession KP system complete with all 13 professions.' },
    ],
    close: '✕ Close'
  },
  ...
  da: {
    ...
    sections: [
      ...
      { icon:'📋', title:'Changelog', text:'<strong>v7.5</strong> — Rotation-fane-fix (undefined tekst løst), Ugentlig Crafting Quest-reference korrigeret, hjælpeguide opdateret.<br><br><strong>v7.4</strong> — Talents-fane (🌳) tilføjet til alle specs med links til Icy Veins + Method.gg. Klasser sorteret alfabetisk. 8 spec-filer fuldført.<br><br><strong>v7.3</strong> — Alle /way koordinater i Weeklies verificeret i spillet og korrigeret. KP Træ + KP Kilder-faner tilføjet til Professioner.<br><br><strong>v7.2</strong> — Specs-sektion lanceret: 39 specs, 8 faner per spec.<br><br><strong>v7.0</strong> — Profession KP-system komplet med alle 13 professioner.' },
    ],
    close: '✕ Luk'
  },
