...
const HELP_CONTENT = {
  ...
  da: {
    ...
    sections: [
      ...
      { icon:'📋', title:'Changelog', text:`<strong>v1.0</strong> — 📖 Ordbog tilføjet (16 begreber forklaret for begyndere). Ordbog-fane + inline gyldne tooltips i dungeon-tips. Nysarra rettet: STÅ I såret = DU gør 300% mere skade PÅ bossen. Nav-faner vandret-scrollbare.<br><br><strong>v0.9</strong> — 🐉 Trash mob-guide tilføjet til alle 12 dungeons (69 mobs med interrupt/dodge/purge tags). Alle bosser i alle 8 M+ dungeons grundigt kontrolleret og rettet mod Method.gg &amp; Icy Veins (bl.a. Seranel Sunlash, Degentrius, Algeth'ar Academy, Pit of Saron, Seat of the Triumvirate, Skyreach fuldstændigt omskrevet).<br><br><strong>v0.8</strong> — 🏰 Raids-sektion tilføjet (The Dreamrift fuldt udarbejdet). ⚡ Affixes-fane tilføjet. Navigation folder til 2 rækker på mobil. Rotation-fix (undefined tekst). Ugentlig Crafting Quest korrigeret.<br><br><strong>v0.7</strong> — Talents-fane (🌳) tilføjet til alle specs med links til Icy Veins + Method.gg. Klasser sorteret alfabetisk. 8 spec-filer fuldført.<br><br><strong>v0.6</strong> — Alle /way koordinater i Weeklies verificeret i spillet og korrigeret. KP Træ + KP Kilder-faner tilføjet til Professioner.<br><br><strong>v0.5</strong> — Specs-sektion lanceret: 39 specs, 8 faner per spec.<br><br><strong>v0.4</strong> — Profession KP-system komplet med alle 13 professioner.` },
    ],
    close: '✕ Luk'
  },
