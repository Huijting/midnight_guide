...
const HELP_CONTENT = {
  ...
  nl: {
    ...
    sections: [
      ...
      { icon:'🎯', title:'Specs',             text:'Kies je klasse en spec uit het overzicht (alfabetisch gesorteerd) — alle 13 klassen zijn beschikbaar met meerdere specs. Je krijgt 9 tabbladen per spec:\n⚡ Cheat Sheet — de rotatie in één oogopslag\n🔄 Rotatie — opener, single target en AoE uitgewerkt\n📊 Stats — welke stats prioriteit krijgen en waarom\n💀 Cooldowns — wanneer gebruik je wat\n💡 Tips — handige ezelsbruggetjes\n🖱️ Macro\'s — kant-en-klare macros, klik om te kopiëren\n🎯 Resource — hoe je resource werkt (Focus, Holy Power, Runes...)\n🧪 Consumables — beste flask, potion, food en augment rune\n🌳 Talents — aanbevolen builds voor M+, Raid, Delves en Leveling met directe links naar Icy Veins en Method.gg\n\nBeschikbare klassen (alfabetisch): Death Knight, Demon Hunter, Druid, Evoker, Hunter, Mage, Monk, Paladin, Priest, Rogue, Shaman, Warlock, Warrior' },
  ...
  en: {
    ...
    sections: [
      ...
      { icon:'🎯', title:'Specs',              text:"Choose your class and spec from the overview (sorted alphabetically) — all 13 classes available with multiple specs. You get 9 tabs per spec:\n⚡ Cheat Sheet — the rotation at a glance\n🔄 Rotation — opener, single target and AoE worked out\n📊 Stats — which stats to prioritize and why\n💀 Cooldowns — when to use what\n💡 Tips — handy reminders\n🖱️ Macros — ready-made macros, click to copy\n🎯 Resource — how your resource works (Focus, Holy Power, Runes...)\n🧪 Consumables — best flask, potion, food and augment rune\n🌳 Talents — recommended builds for M+, Raid, Delves and Leveling with direct links to Icy Veins and Method.gg\n\nAvailable classes (alphabetical): Death Knight, Demon Hunter, Druid, Evoker, Hunter, Mage, Monk, Paladin, Priest, Rogue, Shaman, Warlock, Warrior" },
  ...
  da: {
    ...
    sections: [
      ...
      { icon:'🎯', title:'Specs',              text:'Vælg din klasse og spec fra oversigten (sorteret alfabetisk) — alle 13 klasser er tilgængelige med flere specs. Du får 9 faner per spec:\n⚡ Snydeark — rotationen på et øjeblik\n🔄 Rotation — opener, single target og AoE udarbejdet\n📊 Stats — hvilke stats der prioriteres og hvorfor\n💀 Cooldowns — hvornår bruger du hvad\n💡 Tips — nyttige huskeremser\n🖱️ Makroer — færdige makroer, klik for at kopiere\n🎯 Ressource — hvordan din ressource fungerer (Focus, Holy Power, Runes...)\n🧪 Forbrug — bedste flask, potion, mad og augment rune\n🌳 Talents — anbefalede builds til M+, Raid, Delves og Leveling med direkte links til Icy Veins og Method.gg\n\nTilgængelige klasser (alfabetisk): Death Knight, Demon Hunter, Druid, Evoker, Hunter, Mage, Monk, Paladin, Priest, Rogue, Shaman, Warlock, Warrior' },
