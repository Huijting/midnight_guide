...
const MINING = {
  ...
  specs:[
    ...
    {
      title:{nl:'⛏ Boom 1 — Master Miner · begin hier, altijd',en:'⛏ Tree 1 — Master Miner · start here, always',da:'⛏ Træ 1 — Master Miner · start her, altid'},
      desc:{
    ...
    {
      title:{nl:'💥 Boom 2 — Explosive Mining · voor massale oogst',en:'💥 Tree 2 — Explosive Mining · for mass harvesting',da:'💥 Træ 2 — Eksplosiv Minedrift · til masseindsamling'},
      desc:{
    ...
    {
      title:{nl:'🔭 Boom 3 — Survey Mastery · spoor zeldzame erts op',en:'🔭 Tree 3 — Survey Mastery · track rare ore',da:'🔭 Træ 3 — Undersøgelsesmesteri · spor sjælden malm'},
      desc:{
    ...
    {
      title:{nl:'🔥 Boom 4 — Refined Smelting · smelt voor hogere waarde',en:'🔥 Tree 4 — Refined Smelting · smelt for higher value',da:'🔥 Træ 4 — Raffineret Smeltning · smelt for højere værdi'},
      desc:{
        nl:'<strong>Wat doet het?</strong> Je leert erts om te smelten naar staven van hogere kwaliteit. Normaal smelt je Void-Iron Ore naar Void-Iron Bar. Met Refined Smelting kun je het verder verwerken naar <em>Reinforced Void-Iron Bar</em> — een stap hoger, meer waard, en gevraagd door Blacksmiths voor hun beste recepten.<br><br><strong>Waarom verkopen staven beter dan erts?</strong> Crafters (Blacksmiths, Engineers) moeten zelf smelten als ze ruwe erts kopen. Dat kost tijd en requires soms ook een specifieke locatie. Als jij al staven verkoopt, bespaar je hen werk — ze betalen een premium voor het gemak.<br><br><strong>Hoe groot is het verschil?</strong> Reinforced staven verkopen gemiddeld 40-60% duurder per eenheid erts dan het ruwe materiaal. Als je grote hoeveelheden farmt, scheelt dat significant op jaarbasis.',
        en:'<strong>What does it do?</strong> You learn to smelt ore into higher quality bars. Normally you smelt Void-Iron Ore into Void-Iron Bar. With Refined Smelting you can further process it into <em>Reinforced Void-Iron Bar</em> — one step higher, more valuable, and in demand by Blacksmiths for their best recipes.<br><br><strong>Why do bars sell better than ore?</strong> Crafters (Blacksmiths, Engineers) have to smelt themselves if they buy raw ore. That costs time and sometimes requires a specific location. If you sell bars already, you save them work — they pay a premium for the convenience.<br><br><strong>How big is the difference?</strong> Reinforced bars sell on average 40-60% more per ore unit than raw material. If you farm large quantities, that makes a significant difference.',
        da:'<strong>Hvad gør det?</strong> Du lærer at smelte malm til stænger af højere kvalitet — <em>Reinforced Void-Iron Bar</em>.<br><br><strong>Hvorfor sælger stænger bedre?</strong> Crafters betaler en præmie for bekvemmelighed. Reinforced stænger sælger gennemsnitligt 40-60% dyrere pr. malmenhed end råt materiale.'
      },
      points:{nl:'15 punten — doe dit als je al mining-routes rijdt en bulk wilt omzetten',en:'15 points — do this if you already run mining routes and want to convert bulk',da:'15 point — gør dette hvis du allerede kører mining-ruter og vil konvertere bulk'}
    }
  ],
  items:[
