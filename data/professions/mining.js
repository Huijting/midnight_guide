...
const MINING = {
  ...
  specs:[
    {
      title:{nl:'📖 Mining KP en specialisatie in Midnight',en:'📖 Mining KP and specialization in Midnight',da:'📖 Mining KP og specialisering i Midnight'},
      desc:{
        ...
        da:'Mining har et andet KP-system. 1 KP for hvert nyt nodetype — 25 i alt. Uge 1: ~81 KP. Derefter ~13 KP/uge.<br><br>Alle tre ore-typer i alle zoner. Dazzling Thorium: sjælden drop til high-end gear.'
      },
      points:{nl:'Tip: mijn elk nodevariant minimaal één keer — gratis 25 KP in de eerste week',en:'Tip: mine each node variant at least once — free 25 KP in the first week',da:'Tip: min hvert node-variant mindst én gang — gratis 25 KP i første uge'}
    },
    {
      title:{nl:'⛏ Boom 1 — Meticulous Mining · gemonteerd minen + passieve stats',en:'⛏ Tree 1 — Meticulous Mining · mounted mining + passive stats',da:'⛏ Træ 1 — Meticulous Mining · minedrift til hest + passive stats'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> 40 root-point = minedrift til hest. Vigtigste QoL-opgradering til Mining. Giver også Finesse, Perception og Vigor-gendannelse.<br><br>Lås op straks som andet træ efter Over-LODED entry.'
      },
      points:{nl:'40 punten = gemonteerd minen actief — eerste prioriteit na Over-LODED',en:'40 points = mounted mining active — first priority after Over-LODED',da:'40 point = minedrift til hest aktiv — første prioritet efter Over-LODED'}
    },
    {
      title:{nl:'💎 Boom 2 — Plentiful Ores · meer ore per mining node',en:'💎 Tree 2 — Plentiful Ores · more ore per mining node',da:'💎 Træ 2 — Plentiful Ores · mere malm pr. minedrift-node'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Øger skill for alle ore-typer. 50 root-point: +20 Mining Skill for alle Midnight ore. Under-specs pr. ore: mere skill for ét specifikt ore + øget Dazzling Thorium drop rate.<br><br>Spred point jævnt over de ore-typer du farmer mest.'
      },
      points:{nl:'50 punten root → dan ore-specifieke sub-specs op basis van welk ore je het meest farmt',en:'50 points root → then ore-specific sub-specs based on which ore you farm most',da:'50 point root → derefter ore-specifikke under-specs baseret på hvad du farmer mest'}
    },
    {
      title:{nl:'⚡ Boom 3 — Over-LODED · infused deposits overloaden',en:'⚡ Tree 3 — Over-LODED · overloading infused deposits',da:'⚡ Træ 3 — Over-LODED · overload infused deposits'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Forbedrer Overload Infused Deposit. Under-specs: Wild (ekstra malm fra Orelings), Lightfused (dobbelte Motes), Primal (ekstra ticks), Voidbound (Mote + portal).<br><br><strong>ADVARSEL Voidbound:</strong> Overload IKKE Voidbound-noder uden under-spec — tilfældig teleport til farlig lokation!'
      },
      points:{nl:'Unlock root ZONDER punten eerst → kies sub-spec op basis van favoriete elementale zone',en:'Unlock root WITHOUT points first → pick sub-spec based on favorite elemental zone',da:'Åbn root UDEN point først → vælg under-spec baseret på favorit elementalzone'}
    }
  ],
  items:[
