...
const ENCHANTING = {
  ...
  specs:[
    {
      title:{nl:'📖 De vier Enchanting-specialisatietakken',en:'📖 The four Enchanting specialization trees',da:'📖 De fire Fortryllelses-specialiseringstræer'},
      desc:{
        ...
        da:'Fortryllelse har <strong>fire specialiseringstræer</strong>: <em>Elevating Equipment</em>, <em>Transitories, Tonics & Tools</em>, <em>Disenchanting Delegate</em> og <em>Spellbound Shatterer</em>. Låses op ved færdighed 25, 50, 60 og 75.<br><br>Dag 1: ~60–70 KP. Derefter ~17 KP/uge. Enchants sælges på Vellum via AH — passiv indkomst.'
      },
    ...
    {
      title:{nl:'✨ Boom 1 — Elevating Equipment · alle gear-enchants per factie',en:'✨ Tree 1 — Elevating Equipment · all gear enchants by faction',da:'✨ Træ 1 — Elevating Equipment · alle gear-fortryllelser pr. fraktion'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Alle gear-slot-fortryllelser organiseret per <strong>fraktion</strong>:<br>• Thalassian Talents — Wåben, Ring, Bryst, Hjelm, Skulder, Støvle, Redskab<br>• Amani Augments — samme slots, Amani-stil<br>• Haranir Heightening — samme slots, Haranir-stil<br><br>30 point i root → åbner alle tre under-specs. Invest i één fraktion om alle slots te dekken.'
      },
      points:{nl:'30 punten root → kies één factie-sub-spec (20 punten) → alle enchant-slots van die factie ontgrendeld',en:'30 points root → pick one faction sub-spec (20 points) → all enchant slots for that faction unlocked',da:'30 point root → vælg én fraktion-under-spec (20 point) → alle enchant-slots for den fraktion låst op'}
    },
    {
      title:{nl:'🧪 Boom 2 — Transitories, Tonics & Tools · consumables en Illusions',en:'🧪 Tree 2 — Transitories, Tonics & Tools · consumables and Illusions',da:'🧪 Træ 2 — Transitories, Tonics & Tools · forbrugsvarer og Illusioner'},
      desc:{
        ...
        da:'<strong>Hvad laver dette?</strong> Mana Oils (temporær mana-regen buff), Combat Wands, Enchanting Rod og Temporary Illusions.<br><br><strong>Mana Oils er tilbage:</strong> Casters og healere bruger dem som våbenbuff. Stabilt niche-marked.'
      },
      points:{nl:'5 punten root → kies sub-spec op basis van markt (Mana Oils vs. Illusions vs. Wands)',en:'5 points root → pick sub-spec based on market (Mana Oils vs. Illusions vs. Wands)',da:'5 point root → vælg under-spec baseret på marked (Mana Oils vs. Illusioner vs. Stave)'}
    },
    {
      title:{nl:'💎 Boom 3 — Disenchanting Delegate · betere materialen',en:'💎 Tree 3 — Disenchanting Delegate · better materials',da:'💎 Træ 3 — Disenchanting Delegate · bedre materialer'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Bedre materialer fra disenchanting. Under-specs:<br>• Dust Deliverer — mere dust fra grønt gear<br>• Shard Supplier — mere shards fra blåt gear<br>• Crystal Collector — mere crystals fra episk gear<br><br>Dawn Shatter og Radiant Shatter tilgængelige fra dag 1.'
      },
      points:{nl:'30 punten root → kies één sub-spec op basis van welk gear je het meest disenchant',en:'30 points root → pick one sub-spec based on which gear you disenchant most',da:'30 point root → vælg under-spec baseret på hvilken gear du oftest disenchanter'}
    },
    {
      title:{nl:'⚡ Boom 4 — Spellbound Shatterer · crafting stats + Shatter Essence',en:'⚡ Tree 4 — Spellbound Shatterer · crafting stats + Shatter Essence',da:'⚡ Træ 4 — Spellbound Shatterer · crafting-stats + Shatter Essence'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Øger crafting-stats for alle fortryllelser. Låser Shatter Essence op: forbruge Mote for midlertidig boost. <strong>OBS: ikke passiv</strong> — aktivér Shatter Essence FØR craft.<br><br>Under-specs: Responsible Resources (Resourcefulness) og Infinite Ingenuity (Ingenuity).'
      },
      points:{nl:'20 punten → Shatter Essence actief → Responsible Resources of Infinite Ingenuity als sub-spec',en:'20 points → Shatter Essence active → Responsible Resources or Infinite Ingenuity as sub-spec',da:'20 point → Shatter Essence aktiv → Responsible Resources eller Infinite Ingenuity som under-spec'}
    }
  ],
  items:[
