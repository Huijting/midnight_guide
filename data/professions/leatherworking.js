...
const LEATHERWORKING = {
  ...
  specs:[
    {
      title:{nl:'📖 De vier Leatherworking-specialisatietakken',en:'📖 The four Leatherworking specialization trees',da:'📖 De fire Læderarbejde-specialiseringstræer'},
      desc:{
        ...
        da:'Læderarbejde har <strong>fire specialiseringstræer</strong>: <em>Lasting Leather</em>, <em>Safeguarding Scales</em>, <em>Flawless Fortes</em> og <em>Learned Leatherworker</em>. Låses op ved færdighed 25, 50, 60, 75.<br><br>Dag 1: ~40–50 KP. Derefter ~19 KP/uge.'
      },
      points:{nl:'Tip: kies Lasting Leather (leer) of Safeguarding Scales (mail) op basis van welke klassen het populairst zijn',en:'Tip: pick Lasting Leather (leather) or Safeguarding Scales (mail) based on which classes are most popular',da:'Tip: vælg Lasting Leather (læder) eller Safeguarding Scales (brynje) baseret på populære klasser'}
    },
    {
      title:{nl:'🦺 Boom 1 — Lasting Leather · leren armor voor Rogues, Druids, Monks, DHs',en:'🦺 Tree 1 — Lasting Leather · leather armor for Rogues, Druids, Monks, DHs',da:'🦺 Træ 1 — Lasting Leather · læderpanser til Rogues, Druids, Monks, DHs'},
      desc:{
        ...
        da:'<strong>Hvad laver dette?</strong> Episk læderpanser til Rogues, Druids, Monks og Demon Hunters. 30 root-point → under-specs pr. slot-gruppe (venstre: Hoved/Bryst/Skulder/Håndled; højre: Ben/Hænder/Midje/Fødder).'
      },
      points:{nl:'30 punten root → kies linker of rechter slotgroep → 30 punten sub-spec voor alle vier slots',en:'30 points root → pick left or right slot group → 30 points sub-spec for all four slots',da:'30 point root → vælg venstre eller højre slot-gruppe → 30 point under-spec for alle fire slots'}
    },
    {
      title:{nl:'🔗 Boom 2 — Safeguarding Scales · mail armor voor Hunters, Shams, Evokers',en:'🔗 Tree 2 — Safeguarding Scales · mail armor for Hunters, Shams, Evokers',da:'🔗 Træ 2 — Safeguarding Scales · brynjepost til Hunters, Shamans, Evokers'},
      desc:{
        ...
        da:'<strong>Hvad laver dette?</strong> Episk brynjepost til Hunters, Shamans og Evokers. Identisk struktur som Lasting Leather.<br><br>Tjek din servers klassefordeling for at vælge Leather vs. Mail.'
      },
      points:{nl:'Zelfde structuur als Lasting Leather — kies op basis van server-populariteit van leather vs. mail klassen',en:'Same structure as Lasting Leather — pick based on server popularity of leather vs. mail classes',da:'Samme struktur som Lasting Leather — vælg baseret på leder vs. brynje klasse-popularitet på serveren'}
    },
    {
      title:{nl:'🔧 Boom 3 — Flawless Fortes · armor kits, profession gear en optional reagents',en:'🔧 Tree 3 — Flawless Fortes · armor kits, profession gear and optional reagents',da:'🔧 Træ 3 — Flawless Fortes · rustningssæt, professionsgear og valgfrie reagenser'},
      desc:{
        ...
        da:'<strong>Hvad laver dette?</strong> Ben-rustningssæt (alle karakterer vil have dem), professions-redskaber og valgfrie reagenser.<br><br>Ben-sæt: stabilt AH-marked. Professions-redskaber: bred lanceringsefterspørgsel.'
      },
      points:{nl:'Leg armor kits als eerste — breed en stabiel, dan profession tools voor brede crafter-markt',en:'Leg armor kits first — broad and stable, then profession tools for broad crafter market',da:'Ben-rustningssæt først — bredt og stabilt, derefter professions-redskaber'}
    },
    {
      title:{nl:'📈 Boom 4 — Learned Leatherworker · crafting stats voor alles',en:'📈 Tree 4 — Learned Leatherworker · crafting stats for everything',da:'📈 Træ 4 — Learned Leatherworker · crafting-stats til alt'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Øger Ingenuity, Multicraft og Resourcefulness for alle LW-crafts. Under-spec: Waning Waste (Resourcefulness).<br><br><strong>Anbefaling:</strong> Start her med Waning Waste — sparer materialer på alt fra dag 1.'
      },
      points:{nl:'5 punten root → Waning Waste sub-spec → Resourcefulness actief op alle LW crafts',en:'5 points root → Waning Waste sub-spec → Resourcefulness active on all LW crafts',da:'5 point root → Waning Waste under-spec → Resourcefulness aktiv på alle LW-crafts'}
    }
  ],
  items:[
