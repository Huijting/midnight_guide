...
const HERBALISM = {
  ...
  specs:[
    {
      title:{nl:'📖 Herbalism KP en specialisatie in Midnight',en:'📖 Herbalism KP and specialization in Midnight',da:'📖 Herbalism KP og specialisering i Midnight'},
      desc:{
        ...
        da:'Herbalism har et andet KP-system end craftingprofessioner. Du tjener <strong>1 KP</strong> for hvert nyt nodetype du plukker — 34 i alt. Uge 1: ~91 KP. Derefter ~13 KP/uge.<br><br>Alle fem basisurter findes i alle zoner. Elementale varianter giver Motes som bonus.'
      },
      points:{nl:'Tip: pluk van elk nodevariant minimaal één keer — gratis 34 KP in de eerste week',en:'Tip: gather each node variant at least once — free 34 KP in the first week',da:'Tip: pluk hvert node-variant mindst én gang — gratis 34 KP i første uge'}
    },
    {
      title:{nl:'🌿 Boom 1 — Plentiful Herbs · meer kruiden per pluking',en:'🌿 Tree 1 — Plentiful Herbs · more herbs per gather',da:'🌿 Træ 1 — Plentiful Herbs · flere urter pr. plukning'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Øger skill og Finesse for alle urttyper — mere output pr. plukning og højere chance for Gold Quality.<br><br>Dit er din brød-og-smør-træ. Invester her efter Over-LODED entry.'
      },
      points:{nl:'Breed distribueren over kruid-types voor generale boost, of diep in één type voor gespecialiseerde farming',en:'Spread broadly across herb types for general boost, or deep in one type for specialized farming',da:'Spred bredt over urttyper for generel boost, eller dybt i én type for specialiseret farming'}
    },
    {
      title:{nl:'⚡ Boom 2 — Over-LODED · infused nodes overloaden voor Motes',en:'⚡ Tree 2 — Over-LODED · overloading infused nodes for Motes',da:'⚡ Træ 2 — Over-LODED · overload infused nodes for Motes'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Forbedrer Overload Infused Deposit — cooldown-reduktion og mere Motes pr. overload. Under-specs: Lightfused, Wild, Primal, Voidbound.<br><br><strong>OBS Voidbound:</strong> Uden under-spec teleporteres du tilfældigt. Køb Voidbound-spec FØR du overloader i Voidstorm.'
      },
      points:{nl:'Unlock Over-LODED root eerst (zonder punten) voor cooldown-reset bij pluken — dan sub-spec kiezen',en:'Unlock Over-LODED root first (without spending points) for cooldown reset while gathering — then pick sub-spec',da:'Åbn Over-LODED root først (uden point) for cooldown-nulstilling ved plukning — vælg derefter under-spec'}
    }
  ],
  items:[
