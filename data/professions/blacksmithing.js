...
const BLACKSMITHING = {
  ...
  specs:[
    ...
    {
      title:{nl:'🛡 Boom 1 — Plate Armor Mastery · begin hier',en:'🛡 Tree 1 — Plate Armor Mastery · start here',da:'🛡 Træ 1 — Pladrustningskunst · start her'},
      desc:{
    ...
    {
      title:{nl:'⚔ Boom 2 — Weapon Mastery · voor alle klassen',en:'⚔ Tree 2 — Weapon Mastery · for all classes',da:'⚔ Træ 2 — Vaabenkunst · til alle klasser'},
      desc:{
    ...
    {
      title:{nl:'🔧 Boom 3 — Tool Crafting · de unieke Blacksmithing-markt',en:'🔧 Tree 3 — Tool Crafting · the unique Blacksmithing market',da:'🔧 Træ 3 — Redskabsfremstilling · det unikke Smedning-marked'},
      desc:{
    ...
    {
      title:{nl:'⚡ Boom 4 — Resonance Tempering · upgrade je eigen items',en:'⚡ Tree 4 — Resonance Tempering · upgrade your own items',da:'⚡ Træ 4 — Resonanstemporering · opgrader dine egne genstande'},
      desc:{
