...
const FISHING = {
  ...
  lore:{
    ...
    da:'Fiskeri er en <em>sekundær profession</em> — som Madlavning bruger den ingen professionspladser. Du fisker fisk og skatte fra søer, floder og specielle "skoler". Fisk bruges i Madlavning og er sælgbare.<br><br>Traditionelt en afslapningsprofession — mange spillere fisker som pause fra aktiv indhold. Nyt i Midnight: Void Pools i Voidstorm-zoner med unikke fisk og sjældne skatte.'
  },
  ...
  trainer:{
    ...
    way:'/way Silvermoon City 41.8 79.3',
    note:{
      ...
      da:'💡 <strong>Fiskeri + Madlavning = perfekt kombination:</strong> Fisk er hovedigredienset til de bedste madretter. Begge sekundære professioner = nul materialomkostninger til Madlavning.'
    }
  },
  specs:[
    {
      title:{nl:'📖 Fishing heeft geen specialisaties — zo maak je er het beste van',en:'📖 Fishing has no specialization tree — make the most of it',da:'📖 Fiskeri har ingen specialiseringstræ — få mest ud af det'},
      desc:{
        ...
        da:'Tre indkomstlag:<br><br><strong>Lag 1 — Fisk til Madlavning:</strong> Midnight Silversail og Void-Touched Catfish til bedste madretter.<br><strong>Lag 2 — Fiskeriskatteindhold:</strong> Hver fanget fisk: chance for sjældne kæledyr, Housing-dekorationer, eller lilla genstande.<br><strong>Lag 3 — Void Pools (ny):</strong> Lilla etheriske vandfladretter i Voidstorm-zoner med unikke fisk og sjældne skatte.<br><br>KP fra <strong>Fiskerifærdighed 25</strong>.'
      },
      points:{nl:'Tip: vis altijd in Schools (gele stippen op wateroppervlak) — die geven het meeste en beste vis',en:'Tip: always fish in Schools (yellow dots on the water surface) — they give the most and best fish',da:'Tip: fisk altid i Skoler (gule prikker på vandoverfladen) — de giver mest og bedst fisk'}
    },
    {
      title:{nl:'🐟 Categorie 1 — Wat te vissen · de beste spots per zone',en:'🐟 Category 1 — What to fish · best spots per zone',da:'🐟 Kategori 1 — Hvad du skal fiske · de bedste spots pr. zone'},
      desc:{
        ...
        da:'<strong>Hvad gør det?</strong> Hurtigere fiskeri, mere fisk pr. træk, højere chance for sjælden bifangst, adgang til Vandsskoler skjult for lavere-skill fiskere.<br><br><strong>Skoltyper:</strong><br>• Silverfin-skoler — normale fisk<br>• Void-sværme — sjældne Void-fisk til Alkymi<br>• Gamle Ruiner-pools — høj chance for skatte'
      },
      points:{nl:'25 punten — het meest tijdefficiënte als je actief wilt vissen',en:'25 points — most time-efficient if you want to actively fish',da:'25 point — mest tidseffektivt hvis du aktivt vil fiske'}
    },
    {
      title:{nl:'💰 Categorie 2 — Hoe geld te verdienen · vis en cooking',en:'💰 Category 2 — How to make gold · fish and cooking',da:'💰 Kategori 2 — Sådan tjener du guld · fisk og cooking'},
      desc:{
        ...
        da:'<strong>Hvad er Void Pools?</strong> Specielle fiskesteder kun synlige med Void Pool-Mestring. I Voidstorm-zoner.<br><br><strong>Void-Touched Fisk:</strong> Kun i Void Pools. Alkymister har brug for dem til dyre potions. Høj efterspørgsel, lavt udbud = godt guld pr. fisk.<br><br><strong>Void-skattekister:</strong> Sjælden chance for skatte — sjældne kæledyr, Housing-genstande, lilla udstyr.'
      },
      points:{nl:'20 punten — ontgrendel dit als je de gevaarlijkere zones kunt bereiken',en:'20 points — unlock this once you can reach the more dangerous zones',da:'20 point — lås op når du kan nå de farligere zoner'}
    }
  ],
  items:[
    {icon:'🐟',name:{nl:'Midnight Silversail',en:'Midnight Silversail',da:'Midnight Silversejl'},desc:{nl:'Beste vis voor Combat Food. Verkoopt goed aan Cooks die niet willen vissen. Altijd vraag omdat Combat Food verbruiksartikel is.',en:'Best fish for Combat Food. Sells well to Cooks who do not want to fish. Always demand because Combat Food is a consumable.',da:'Bedste fisk til kampmad. Sælger godt til kokke der ikke vil fiske.'},tag:'material'},
    {icon:'🌀',name:{nl:'Void-Touched Catfish',en:'Void-Touched Catfish',da:'Void-Touched Mallefisk'},desc:{nl:'Alleen te vangen in Void Pools. Ingrediënt voor Void-Infused Potions. Hoge prijs, constante vraag van Alchemists.',en:'Only catchable in Void Pools. Ingredient for Void-Infused Potions. High price, constant demand from Alchemists.',da:'Kun i Void Pools. Ingrediens til Void-Infused Potions. Høj pris, konstant efterspørgsel.'},tag:'material'},
    {icon:'🐠',name:{nl:'Aquatische Huisdieren (bijvangst)',en:'Aquatic Pets (bycatch)',da:'Vandlevende Kæledyr (bifangst)'},desc:{nl:'Zeldzame bijvangst bij het vissen. Verzamelaars betalen honderden tot duizenden goud voor zeldzame aquatische pets. Nooit te voorspellen maar altijd leuk.',en:'Rare bycatch while fishing. Collectors pay hundreds to thousands of gold for rare aquatic pets. Never predictable but always exciting.',da:'Sjælden bifangst. Samlere betaler hundredvis til tusindvis af guld for sjældne vandlevende kæledyr.'},tag:'cosmetic'},
    {icon:'🏠',name:{nl:'Aquarium (Housing-decoratie)',en:'Aquarium (Housing decoration)',da:'Akvarium (Housing-dekoration)'},desc:{nl:'Speciaal Housing-item dat je via Fishing kunt opvissen. Een functioneel aquarium in je huis met kleine vissen die rondzwemmen. Gewild bij Housing-enthousiaste spelers.',en:'Special Housing item obtainable via Fishing. A functional aquarium in your home with small fish swimming around. Popular among Housing enthusiasts.',da:'Specielt Housing-genstand via fiskeri. Funktionelt akvarium med svømmende fisk. Populær hos Housing-entusiaster.'},tag:'utility'}
  ],
  orders:{
...
<div class="tip-box"><strong>💡 Best tip for Fishing:</strong> Fish during other activities. Some players fish while watching a video, waiting for raids, or between dungeon runs. It is the only profession where you can leave the computer beside you while doing something else.</div>`,
    da:`<div class="co-step"><div class="co-title">📦 Fiskeri — afslapning med bonusindkomst</div><div class="co-desc">Ikke stor guldtjener men mindst stressfuld aktivitet. Sid, kast, vent. Sælg Void-Touched Catfish på AH og normale fisk til kokke.</div></div>
<div class="co-step"><div class="co-title">⭐ Fiskeri + Madlavning = ultimativ sekundær kombination</div><div class="co-desc">Fisk egne ingredienser → aldrig materialomkostninger til Madlavning → overskud sælges → Festmåltider gratis → sælg til raids.</div></div>
<div class="tip-box"><strong>💡 Bedste tip:</strong> Fisk under andre aktiviteter — den eneste profession hvor du kan lade computeren ligge mens du gør noget andet.</div>`
  },
