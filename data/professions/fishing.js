...
const FISHING = {
  ...
  specs:[
    {
      title:{nl:'📖 Fishing begrijpen — meer dan alleen vissen',en:'📖 Understanding Fishing — more than just fish',da:'📖 Forståelse af Fiskeri — mere end bare fisk'},
      desc:{
    ...
    {
      title:{nl:'🐟 Boom 1 — Master Angler · meer vis per cast',en:'🐟 Tree 1 — Master Angler · more fish per cast',da:'🐟 Træ 1 — Mester-Angler · mere fisk pr. cast'},
      desc:{
    ...
    {
      title:{nl:'🌀 Boom 2 — Void Pool Mastery · zeldzame vissen en schatten',en:'🌀 Tree 2 — Void Pool Mastery · rare fish and treasures',da:'🌀 Træ 2 — Void Pool-Mestring · sjældne fisk og skatte'},
      desc:{
