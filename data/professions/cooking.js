...
const COOKING = {
  ...
  specs:[
    {
      title:{nl:'📖 Waarom Cooking altijd de moeite waard is',en:'📖 Why Cooking is always worth it',da:'📖 Hvorfor Madlavning altid er det værd'},
      desc:{
    ...
    {
      title:{nl:'🍖 Specialisatie 1 — Combat Food · voor raids en dungeons',en:'🍖 Specialization 1 — Combat Food · for raids and dungeons',da:'🍖 Specialisering 1 — Kampsmad · til raids og dungeons'},
      desc:{
    ...
    {
      title:{nl:'🌿 Specialisatie 2 — Stat Food · herstel en utility',en:'🌿 Specialization 2 — Stat Food · recovery and utility',da:'🌿 Specialisering 2 — Stats mad · genopretning og hjælpefunktioner'},
        desc:{
