...
const SKINNING = {
  ...
  lore:{
    ...
    da:'Skindbehandling er en <em>indsamlingsprofession</em> — du laver ingenting, du samler kun. Du dræber dyr i verden og flår deres skind, skæl eller tænder af. Du sælger disse materialer til andre spillere eller bruger dem selv hvis du også har Leatherworking. Skindbehandling er en af de nemmeste måder at tjene guld på, især som begynder — du gør det bare mens du laver quests eller farmer dungeons. Nyt i Midnight: tre systemer der gør Skindbehandling mere interessant og lukrativt end nogensinde.'
  },
  ...
  trainer:{
    ...
    note:{
      ...
      da:'💡 <strong>Vigtigt til senere:</strong> Når du kommer videre og vil farme de bedste (dyreste) materialer, har du også brug for <strong>Madlavning</strong>. Lures — det specielle lokkemad til Majestic-materialer — laves med Madlavning-opskrifter. Du har brug for fisk fra Fishing til dette. Det er smart at lære Madlavning og Fishing med det samme hos de samme trænere i Bazaar!'
    }
  },
  specs:[
    {
      title:{nl:'📖 Skinning KP en specialisatie in Midnight',en:'📖 Skinning KP and specialization in Midnight',da:'📖 Skinning KP og specialisering i Midnight'},
      desc:{
        ...
        da:'Skinning har <strong>tre specialiseringstræer</strong> i Midnight: <em>Thorough Tanning</em>, <em>Gainful Gathering</em> og <em>Talented Tracker</em>. Låses op ved færdighed 25, 50 og 75.<br><br>Nyt: Diffusers (2 Motes → infused beast → dobbelte Motes tilbage). Lures spawner Renowned Beasts med Majestic Materials.'
      },
      points:{nl:'Tip: unlock Thorough Tanning meteen — geeft Sharpen Your Knife voor gegarandeerde Void-Tempered Hide drop',en:'Tip: unlock Thorough Tanning immediately — gives Sharpen Your Knife for guaranteed Void-Tempered Hide drop',da:'Tip: lås Thorough Tanning op straks — giver Sharpen Your Knife for garanteret Void-Tempered Hide drop'}
    },
    {
      title:{nl:'🦴 Boom 1 — Thorough Tanning · standaard leer en schubben',en:'🦴 Tree 1 — Thorough Tanning · standard leather and scales',da:'🦴 Træ 1 — Thorough Tanning · standard læder og skæl'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Øger skill for Void-Tempered Leather og Scales. 10 root-point: <em>Sharpen Your Knife</em> — garanteret Void-Tempered Hide/Plating ved næste skinning. 1-times cooldown.<br><br>Første træ. Giver straks Sharpen Your Knife.'
      },
      points:{nl:'40 punten = extra Sharpen Your Knife charges + significante skill-boost voor leer en schubben',en:'40 points = extra Sharpen Your Knife charges + significant skill boost for leather and scales',da:'40 point = ekstra Sharpen Your Knife charges + markant skill-boost for læder og skæl'}
    },
    {
      title:{nl:'🌟 Boom 2 — Gainful Gathering · Motes, vlees en Diffusers',en:'🌟 Tree 2 — Gainful Gathering · Motes, meat and Diffusers',da:'🌟 Træ 2 — Gainful Gathering · Motes, kød og Diffusers'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Låser op for Motes, kød og artsspecifikke drops. Under-spec: Dedicated Diffuser (Diffusers for dobbelte Motes) og Careful Carving (mere kød).<br><br>Diffusers: 2 Motes ind → infused beast → mere end 2 Motes ud. Ingen cooldown.'
      },
      points:{nl:'10 punten root → Dedicated Diffuser sub-spec → Trophy Taker voor Perception en dier-specifieke drops',en:'10 points root → Dedicated Diffuser sub-spec → Trophy Taker for Perception and species-specific drops',da:'10 point root → Dedicated Diffuser under-spec → Trophy Taker for Perception og artsspecifikke drops'}
    },
    {
      title:{nl:'🎯 Boom 3 — Talented Tracker · lures en Majestic Materials',en:'🎯 Tree 3 — Talented Tracker · lures and Majestic Materials',da:'🎯 Træ 3 — Talented Tracker · lokker og Majestic Materials'},
      desc:{
        ...
        da:'<strong>Hvad gør dette?</strong> Låser lure-systemet op til Renowned Beasts. Hver zone har sin egen lokke + Grand Beast Lure. Renowned Beasts dropper Majestic Hide, Fin eller Claw — sjældne Epic-materialer.<br><br>Component Collector: ekstra drops fra alle skinning-typer kombineret.'
      },
      points:{nl:'Investeer hier nadat Thorough Tanning en Gainful Gathering de basis hebben gelegd',en:'Invest here after Thorough Tanning and Gainful Gathering have established the base',da:'Invester her efter Thorough Tanning og Gainful Gathering har lagt grundlaget'}
    }
  ],
  items:[
    {icon:'🦎',name:{nl:'Void-Tempered Leather',en:'Void-Tempered Leather',da:'Void-Tempered Leather'},desc:{nl:'Het meest voorkomende Skinning-materiaal in Midnight. Valt van bijna elk beest. Basisingrediënt voor vrijwel alle Leatherworking leather-armor recepten. Nooit onverkoopbaar op het AH.',en:'The most common Skinning material in Midnight. Drops from almost every beast. Base ingredient for almost all Leatherworking leather armor recipes. Never unsellable on the AH.',da:'Det mest almindelige Skinning-materiale i Midnight. Dropper fra næsten alle dyr. Basingrediens til næsten alle Leatherworking-rustningsopskrifter.'},tag:'material'},
    {icon:'🐍',name:{nl:'Void-Tempered Scales',en:'Void-Tempered Scales',da:'Void-Tempered Scales'},desc:{nl:'Schubben van reptielen, dragonkin en slangenbeesten. Nodig voor Mail armor — het pantserttype dat Hunters en Shamans dragen. Constant gevraagd, goede prijs.',en:'Scales from reptiles, dragonkin and serpent beasts. Required for Mail armor — the armor type worn by Hunters and Shamans. Constantly in demand, good price.',da:'Skæl fra krybdyr, dragonkin og slangedyr. Kræves til brynjrustning — rustningstypen Hunters og Shamaner bærer.'},tag:'material'},
    {icon:'🦴',name:{nl:'Void-Tempered Hide',en:'Void-Tempered Hide',da:'Void-Tempered Hide'},desc:{nl:'Steviger en zeldzamer dan gewoon leer. Valt vaker van High Value Beasts en zeldzamere mobs. Nodig voor gevorderde LW-recepten en Epic gear. Aanzienlijk hogere prijs dan normaal leer.',en:'Sturdier and rarer than normal leather. Drops more often from High Value Beasts and rarer mobs. Needed for advanced LW recipes and Epic gear. Considerably higher price than normal leather.',da:'Stærkere og sjældnere end normalt læder. Dropper oftere fra High Value Beasts og sjældnere monstre. Nødvendigt til avancerede LW-opskrifter og Epic gear.'},tag:'material'},
    {icon:'🦅',name:{nl:'Majestic Fin / Claw / Hide',en:'Majestic Fin / Claw / Hide',da:'Majestic Fin / Claw / Hide'},desc:{nl:'De absolute topmaterialen van Skinning — het duurste wat je kunt droppen. Alleen verkrijgbaar door een Lure te gebruiken en een Renowned Beast te skinnen. Eén keer per dag, per zone. Altijd hoge AH-prijs omdat ze zo zeldzaam zijn.',en:'The absolute top materials from Skinning — the most expensive you can drop. Only obtainable by using a Lure and skinning a Renowned Beast. Once per day, per zone. Always high AH price because they are so rare.',da:'De absolutte topmaterialer fra Skinning — det dyreste du kan droppe. Kun opnåeligt ved at bruge en Lure og skinde et Renowned Beast. Én gang pr. dag, pr. zone.'},tag:'material'},
    {icon:'✨',name:{nl:'Motes (via Diffusers)',en:'Motes (via Diffusers)',da:'Motes (via Diffusers)'},desc:{nl:'Motes zijn kleine elementaire deeltjes die je kunt verkopen. Diffusers zijn kleine flesjes die je craftet van 2 Motes. Gooi een Diffuser op een beest, skin het, en je krijgt 3 of meer Motes terug. Je geeft 2 uit en krijgt 3+ terug — gratis winst!',en:'Motes are small elemental particles you can sell. Diffusers are small vials you craft from 2 Motes. Throw a Diffuser on a beast, skin it, and you get 3 or more Motes back. You spend 2 and get 3+ back — free profit!',da:'Motes er små elementære partikler du kan sælge. Diffusers er små flasker du laver af 2 Motes. Kast en Diffuser på et dyr, skind det, og du får 3 eller flere Motes tilbage.'},tag:'material'}
  ],
  orders:{
...
<div class="tip-box"><strong>💡 Free tip many people don't know:</strong> If another player defeated a beast but did NOT skin it, you are free to skin it! They already took the regular loot (gold, gear) — but the hide is a separate item that is yours if you get there first. Always do it when you see it. Completely free!</div>`,
    da:`<div class="co-step"><div class="co-title">📦 Hurtig forklaring: hvad er forskellen fra en craftingprofession?</div><div class="co-desc">Skindbehandling er en <strong>indsamlingsprofession</strong> — du laver ingenting. Det betyder også: der er <strong>ingen Crafting Orders</strong> til Skindbehandling. Crafting Orders er opgaver andre spillere giver dig for at lave noget. Det eksisterer ikke for indsamling.<br><br>Hvad du gør i stedet: du sælger dine materialer på <strong>Auction House (AH)</strong>. Det er spilmarkedspladsen, der findes i hver større by. Du sætter en genstand til salg til en pris du vælger, og andre spillere køber den.</div></div>
<div class="co-step"><div class="co-title">💰 Hvad sælger bedst — og hvorfor?</div><div class="co-desc">
  <strong>🥇 Majestic Fin / Claw / Hide</strong> — Sjældnest, kun via Lures, altid høj pris<br>
  <strong>🥈 Void-Tempered Hide</strong> — Sjældnere end normalt læder, kræves til Epic gear<br>
  <strong>🥉 Void-Tempered Scales</strong> — Kræves til brynjrustning, konstant efterspørgsel<br>
  <strong>Void-Tempered Leather</strong> — Mest almindelig, lavere pris men store mængder
</div></div>
<div class="co-step"><div class="co-title">📅 Daglig rutine — maksimalt udbytte</div><div class="co-desc">
  <strong>1. Gå altid til High Value Beasts først (minimap)</strong> — 3-4x mere læder, altid prioritet<br>
  <strong>2. Brug dine Diffusers</strong> — Kast på dyr inden skinning, få flere Motes tilbage end det kostede<br>
  <strong>3. Brug dine Lures hver dag</strong> — Ét Renowned Beast pr. zone pr. dag = Majestic materialer. Fire zoner = fire chancer dagligt. 5 minutter pr. zone!
</div></div>
<div class="tip-box"><strong>💡 Gratis tip:</strong> Hvis en anden spiller besejrede et dyr men IKKE skindede det, er du fri til at skinde det! De tog allerede den normale loot — skindet er dit hvis du er der først. Gør altid dette!</div>`
  },
