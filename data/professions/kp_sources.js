...
// Coördinaten: wow-professions.com (maart 2026). TomTom uiMapID: Silvermoon #2393, Eversong #2395, Zul'Aman #2437, Harandar #2413, Voidstorm #2405 (zie data/delves.js / Method.gg).
// Regels met zone "Atal'Aman": coördinaten zijn voor de delve-instance — blijven als /way Atal'Aman … (geen #2437; dat is alleen de openwereldkaart).
// ============================================================
...
const KP_SOURCES = {
  ...
  alchemy: {
    treasures: [
      ...
      { name:"Vial of Voidstorm Oddities",    zone:"Voidstorm",       way:"/way #2405 41.9 40.6" },
    ]
  },
  ...
  blacksmithing: {
    treasures: [
      ...
      { name:"Voidstorm Defense Spear",         zone:"Voidstorm",       way:"/way #2405 30.6 69.0" },
    ]
  },
  ...
  engineering: {
    treasures: [
      ...
      { name:"Ethereal Stormwrench",         zone:"Voidstorm",       way:"/way #2405 54.1 51.1" },
      { name:"Miniaturized Transport Skiff", zone:"Voidstorm",       way:"/way #2405 28.9 39.1" },
    ]
  },
  ...
  inscription: {
    treasures: [
      ...
      { name:"Void-Touched Quill",          zone:"Voidstorm",       way:"/way #2405 60.7 84.3",  note:"Binnen het gebouw" },
    ]
  },
  ...
  jewelcrafting: {
    treasures: [
      ...
      { name:"Speculative Voidstorm Crystal",  zone:"Voidstorm",       way:"/way #2405 30.5 69.1" },
      { name:"Ethereal Gem Pliers",            zone:"Voidstorm",       way:"/way #2405 54.2 51.2" },
      { name:"Shattered Glass",                zone:"Voidstorm",       way:"/way #2405 62.7 53.4" },
    ]
  },
  ...
  leatherworking: {
    treasures: [
      ...
      { name:"Patterns: Beyond the Void",       zone:"Voidstorm",       way:"/way #2405 53.7 51.7" },
    ]
  },
  ...
  tailoring: {
    treasures: [
      ...
      { name:"Book of Sin'dorei Stitches",        zone:"Voidstorm",       way:"/way #2405 62.0 83.6" },
      { name:"Satin Throw Pillow",                zone:"Voidstorm",       way:"/way #2405 61.6 85.0" },
    ]
  },
  ...
  mining: {
    treasures: [
      ...
      { name:"Miner's Guide to Voidstorm",zone:"Voidstorm",      way:"/way #2405 30.5 69.1" },
      { name:"Glimmering Void Pearl",     zone:"Voidstorm",      way:"/way #2405 28.7 38.5" },
      { name:"Lost Voidstorm Satchel",    zone:"Voidstorm",      way:"/way #2405 54.2 51.5" },
    ]
  },
  ...
  skinning: {
    treasures: [
      ...
      { name:"Voidstorm Leather Sample",   zone:"Voidstorm",       way:"/way #2405 45.5 42.3" },
    ]
  },
