...
// Wowhead item IDs — consumables & BiS display names (v3.6.0 tooltip sync)
const ITEM_IDS = {
...
const WEEKLY_ITEMS = [
  ...
  { id:'w_prey', diff:'medium', dmfOnly:false,
    ...
    desc:{nl:'Voltooi 2 Nightmare Prey hunts voor Champion-track gear (~246+ iLvl, Midnight S1). Track je prooi in de zone en overleef hinderlagen. Telt mee voor Great Vault World.',
  ...
  { id:'w_delve1', diff:'medium', dmfOnly:false,
    ...
    desc:{nl:'Vereist een Restored Coffer Key. Valeera begeleidt je. Bountiful Delves vullen je Great Vault World-slot — Tier 8 levert tot 259 iLvl (Hero). Normale (niet-Bountiful) Delves tellen niet mee voor deze vault-beloning.',
  ...
  { id:'w_delve4', diff:'medium', dmfOnly:false, cat:{nl:'🏚 Delves (Bountiful)',en:'🏚 Delves (Bountiful)'},
    ...
    desc:{nl:'4e run — maximale Great Vault World-voortgang. Opmerking: Tier 8+ Delves geven HERO-track gear in de Great Vault.',
  ...
  { id:'w_prey_hard', dmfOnly:false,
    ...
    desc:{nl:'Eerste 2 Hard Prey hunts geven Veteran/Hero-track beloningen (~233–259+ iLvl, Midnight S1). Telt mee voor Great Vault World. Tip: vallen + ambushes, onder de 5 min per hunt.',
...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('sw.js?v=3.6.0').catch(() => {});
}