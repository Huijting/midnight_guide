...
const TAILORING = {
  ...
  specs:[
    ...
    {
      title:{nl:'🧥 Boom 1 — Cloth Armor Mastery · voor casters',en:'🧥 Tree 1 — Cloth Armor Mastery · for casters',da:'🧥 Træ 1 — Klæderustningskunst · til castere'},
      desc:{
    ...
    {
      title:{nl:'🧣 Boom 2 — Cloak Mastery · markt voor iedereen',en:'🧣 Tree 2 — Cloak Mastery · market for everyone',da:'🧣 Træ 2 — Kappekunst · marked for alle'},
      desc:{
    ...
    {
      title:{nl:'🏠 Boom 3 — Void-Weave Tapestries · Housing markt',en:'🏠 Tree 3 — Void-Weave Tapestries · Housing market',da:'🏠 Træ 3 — Void-Weave Tapisserier · Housing-marked'},
      desc:{
