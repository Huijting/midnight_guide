...
-- Source: content/addon-content.sample.json (professions synced from MPT via sync-mpt-professions.py)
MidnightGuideGeneratedData = {
  ...
  help = {
    install = {
      ...
      steps = {
        ...
        },
        {
          id = "slash-command",
          text = {
            en = "In-game, type /mg to open or close the window. Subcommands: /mg help, /mg prof (profession trackers), /mg weekly, /mg treasures, /mg books, /mg my-treasures, /mg my-books.",
            nl = "In-game: typ /mg om het venster te openen of te sluiten. Subcommando's: /mg help, /mg prof (profession-trackers), /mg weekly, /mg treasures, /mg books, /mg my-treasures, /mg my-books."
          }
        },
        {
          id = "waypoint-rightclick",
          text = {
            en = "On All Treasures / All Books, right-click a line with yellow /way coordinates to set a TomTom arrow (if TomTom is enabled) or a Blizzard map pin.",
            nl = "Bij Alle schatten / Alle boeken: rechtsklik op een regel met gele /way-coördinaten voor een TomTom-pijl (als TomTom aan staat) of een Blizzard-kaart-pin."
          }
        }
      },
    ...
    troubleshooting = {
      ...
      {
        id = "waypoint-different-map",
        text = {
          en = "No TomTom arrow in a delve or instance? Many /way lines target the outdoor world map. The arrow is usually clearest when you are in that same zone. Midnight Guide prints an extra yellow chat line if your current map does not match the waypoint.",
          nl = "Geen TomTom-pijl in een delve of instance? Veel /way-regels gaan over de open-wereldkaart. De pijl werkt meestal het best als je weer in diezelfde buitenzone bent. Midnight Guide toont een extra gele chatregel als je huidige kaart niet bij het waypoint hoort."
        }
      }
    }
  }
